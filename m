...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8C7C468044B
	for <lists+linux-ide@lfdr.de>; Mon, 30 Jan 2023 04:31:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235200AbjA3DbJ (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Sun, 29 Jan 2023 22:31:09 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38430 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232771AbjA3DbG (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Sun, 29 Jan 2023 22:31:06 -0500
Received: from esa1.hgst.iphmx.com (esa1.hgst.iphmx.com [68.232.141.245])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 49C4914EA4
        for <linux-ide@vger.kernel.org>; Sun, 29 Jan 2023 19:31:03 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=wdc.com; i=@wdc.com; q=dns/txt; s=dkim.wdc.com;
  t=1675049462; x=1706585462;
  h=message-id:date:mime-version:subject:to:cc:references:
   from:in-reply-to:content-transfer-encoding;
  bh=vZoRGH8mvmr1p+leDrGnvw3Eu1uQa96pBpeAaVFFNNk=;
  b=VI7ZKqAxIsYSsgYxKGFecezSnSCKoC+DpoOkr/4Dem245kJKu9xFO3gc
   TvjhBjs9hbUNLfrrP1cVSX3bm40/HD88e7ZssSVAOzcnniK5ircrQ6q72
   mZ8p03LLwyXcfxRpb20osdhLaf7oYzLUulWmhN+QkNaN4nLHQqKCGyfA9
   JBvU9Bt7w7zOUhQUXB7VYhCupqdyWfqr5pYMGnNdnoYW+mjWH7yTTiYLf
   tFh22oZoXf9Lg0RBIoCyAN0eXB5n57HklVqYPDNeSv8lM5/2kG+LbECaO
   46pVrrQrq+C01G1IzC1BRDm5Gw/OZPjXmytSc99hhX4hylNGNleEzSzz4
   Q==;
X-IronPort-AV: E=Sophos;i="5.97,257,1669046400"; 
   d="scan'208";a="334009109"
Received: from uls-op-cesaip02.wdc.com (HELO uls-op-cesaep02.wdc.com) ([199.255.45.15])
  by ob1.hgst.iphmx.com with ESMTP; 30 Jan 2023 11:30:58 +0800
IronPort-SDR: 
Received: from uls-op-cesaip02.wdc.com ([10.248.3.37])
  by uls-op-cesaep02.wdc.com with ESMTP/TLS/ECDHE-RSA-AES128-GCM-SHA256; 29 Jan 2023 18:42:40 -0800
IronPort-SDR: 
WDCIronportException: Internal
Received: from usg-ed-osssrv.wdc.com ([10.3.10.180])
  by uls-op-cesaip02.wdc.com with ESMTP/TLS/ECDHE-RSA-AES128-GCM-SHA256; 29 Jan 2023 19:30:58 -0800
Received: from usg-ed-osssrv.wdc.com (usg-ed-osssrv.wdc.com [127.0.0.1])
        by usg-ed-osssrv.wdc.com (Postfix) with ESMTP id 4P4txZ2b80z1RvTr
        for <linux-ide@vger.kernel.org>; Sun, 29 Jan 2023 19:30:58 -0800 (PST)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=
        ...
        1675049452; x=1677641453; bh=vZoRGH8mvmr1p+leDrGnvw3Eu1uQa96pBpe
        AaVFFNNk=; b=ieVwXS17YqFMUw8cFnEbVYGUjneKRKMFycyucbcS6OyK6kShzRV
        
X-Virus-Scanned: amavisd-new at usg-ed-osssrv.wdc.com
Received: from usg-ed-osssrv.wdc.com ([127.0.0.1])
        by usg-ed-osssrv.wdc.com (usg-ed-osssrv.wdc.com [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id Q-64v5qpKvg6 for <linux-ide@vger.kernel.org>;
        Sun, 29 Jan 2023 19:30:52 -0800 (PST)
Received: from [10.149.53.254] (washi.fujisawa.hgst.com [10.149.53.254])
        by usg-ed-osssrv.wdc.com (Postfix) with ESMTPSA id 4P4txR3Qdrz1RvLy;
        Sun, 29 Jan 2023 19:30:51 -0800 (PST)
Message-ID: <d4f7ebd5-d90d-fb96-0fad-bd129ac162dc@opensource.wdc.com>
Date:   Mon, 30 Jan 2023 12:30:50 +0900
MIME-Version: 1.0
...
In-Reply-To: <20230123190954.5085-1-linux@zary.sk>
