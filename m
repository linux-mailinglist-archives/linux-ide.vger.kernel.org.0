Return-Path: <linux-ide+bounces-1119-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 3529F897EF7
	for <lists+linux-ide@lfdr.de>; Thu,  4 Apr 2024 07:05:33 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 595511C26ACE
	for <lists+linux-ide@lfdr.de>; Thu,  4 Apr 2024 05:05:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3E2E274BF0;
	Thu,  4 Apr 2024 05:01:21 +0000 (UTC)
X-Original-To: linux-ide@vger.kernel.org
Received: from sakura.ysato.name (ik1-413-38519.vs.sakura.ne.jp [153.127.30.23])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D6BA7745C0;
	Thu,  4 Apr 2024 05:01:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=153.127.30.23
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712206881; cv=none; b=F7ydnhw6QTbrh6+N8VEdkBGah5ODhqzobBYUdvUMCA9yqVkfu0l/CoD2iG5cBsuJkOlP2y/X0yhvb7SsfFzAFTrerlKdGaIl3PJ/klcvU+3fsFDfDeVhjOBKnMJKEaL4A0yW65KAVBjVO1ecteIeLSYv2YAxwK7F6igQIBI1mvM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712206881; c=relaxed/simple;
	bh=MvQpdX/sSYmof7Bxa6HlKAVNZXKWVUfpsjYKfuvmB9k=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=F8xdiSr3k1lDvLJmVPLggdzOa/iaIHBIJoPw59b/lvMU1QAM0BVNid7BX1A6xrkjAeqJO9ISkbaXcdcZ1xng3D+LXO6a2jS2kvIJSlO45z5FXprLydfiMhCP7c6tZlvL7YWJLsVQVz8gFhlOPDDc7mFOLgiIRNxGFizZqIAZOsY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=users.sourceforge.jp; spf=fail smtp.mailfrom=users.sourceforge.jp; arc=none smtp.client-ip=153.127.30.23
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=users.sourceforge.jp
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=users.sourceforge.jp
Received: from SIOS1075.ysato.name (al128006.dynamic.ppp.asahi-net.or.jp [111.234.128.6])
	by sakura.ysato.name (Postfix) with ESMTPSA id D6DAF1C0BE5;
...
Subject: [PATCH v7 22/37] dt-bindings: display: smi,sm501: SMI SM501 binding json-schema
Date: Thu,  4 Apr 2024 14:00:01 +0900
Message-Id: <9858ef1c149bd27b27594b3bd388601681d83460.1712205900.git.ysato@users.sourceforge.jp>
