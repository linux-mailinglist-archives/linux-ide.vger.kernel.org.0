Return-Path: <linux-ide+bounces-1137-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id B1602898011
	for <lists+linux-ide@lfdr.de>; Thu,  4 Apr 2024 07:20:54 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id D325E1C25BF5
	for <lists+linux-ide@lfdr.de>; Thu,  4 Apr 2024 05:20:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6FCF177F13;
	Thu,  4 Apr 2024 05:15:18 +0000 (UTC)
X-Original-To: linux-ide@vger.kernel.org
Received: from sakura.ysato.name (ik1-413-38519.vs.sakura.ne.jp [153.127.30.23])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4524558109;
	Thu,  4 Apr 2024 05:15:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=153.127.30.23
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712207718; cv=none; b=bHWHlPTNQLzBSvMGJYc7XS7XWR0+stWKOdXmsoi1EcHT00ejT7jOTz+OyimxrIlTbxs8pZIm+d1LGOzkk8ryKJVKmB9DvP6coi3zynGQcccLE8s/YW8eQ6VObK7i0PBU9ov+A/L2W+sUMcZJSWAgc9w5M2U85a3Mb9TzeDx3UdY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712207718; c=relaxed/simple;
	bh=C+jQmWPBYq6FMYzgGImgQJNnONf9kmk2gh8nByNKbYc=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=NK4hXnPbBrOWh7PWbRJTVsFoDVm5xZisLe2EIE6/c9zuq2vcD3WJZtSoKPp2aFGiYoM5nUT9jFBuV+EWuEQICESA6jJ/GrKLa5bSrgQ3es3PWStSCXjIVg0oKjpy5uajw8jSzs1wNrX0XQE7DuUnr4eQAHsfOD75BQ12i9aFu9Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=users.sourceforge.jp; spf=fail smtp.mailfrom=users.sourceforge.jp; arc=none smtp.client-ip=153.127.30.23
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=users.sourceforge.jp
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=users.sourceforge.jp
Received: from SIOS1075.ysato.name (al128006.dynamic.ppp.asahi-net.or.jp [111.234.128.6])
	by sakura.ysato.name (Postfix) with ESMTPSA id 7928B1C0FB4;
	Thu,  4 Apr 2024 14:15:13 +0900 (JST)
...
Subject: [RESEND v7 11/37] pci: pci-sh7751: Add SH7751 PCI driver
Date: Thu,  4 Apr 2024 14:14:22 +0900
Message-Id: <8c44b3e28da65cf47ff6bd53cf8e9cf30f2b4cb0.1712207606.git.ysato@users.sourceforge.jp>
