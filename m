Return-Path: <linux-ide+bounces-1141-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A3D21898030
	for <lists+linux-ide@lfdr.de>; Thu,  4 Apr 2024 07:22:11 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id C493B1C21DEA
	for <lists+linux-ide@lfdr.de>; Thu,  4 Apr 2024 05:22:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E081882D9F;
	Thu,  4 Apr 2024 05:15:25 +0000 (UTC)
X-Original-To: linux-ide@vger.kernel.org
Received: from sakura.ysato.name (ik1-413-38519.vs.sakura.ne.jp [153.127.30.23])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8897482876;
	Thu,  4 Apr 2024 05:15:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=153.127.30.23
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712207725; cv=none; b=EXHZ+AB4NudmulhKQ7mBxgvCMn6o5qVs0LV4u7ABJZFj64cv/BypREDHSa8BC3gj614xTbg3/8O33qv9jS7DFGPAerYwZWwwYL5jpO/ZE2LnM3KZlShm6LTK5O/uOhXaqfOzJSIz5O9M5nO8H/6LbbJz1n/WNt4ru3JOMXiFjhw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712207725; c=relaxed/simple;
	bh=lu04S1z5esVKIKbtLupdeTesyqNKCVwU4W+dAOV5/pg=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=jHmK68slvXZ79wJJ0sjY2uea0t/YEUX7CDvC1oOm2bBVwGqSLnc0WTRJ2EwSXpEzpjQ3NHaHXxPQDDf97fOEFoprq85SlEYH9UUG/pznGIQkDq3bM1J8tF7v8tiX8BxAMgbqRgR+bMiLTtg9XrHZEY7T3w7BV8XtQWS1D1ewh7k=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=users.sourceforge.jp; spf=fail smtp.mailfrom=users.sourceforge.jp; arc=none smtp.client-ip=153.127.30.23
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=users.sourceforge.jp
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=users.sourceforge.jp
Received: from SIOS1075.ysato.name (al128006.dynamic.ppp.asahi-net.or.jp [111.234.128.6])
	by sakura.ysato.name (Postfix) with ESMTPSA id 370BC1C0BDE;
	Thu,  4 Apr 2024 14:15:21 +0900 (JST)
...
Subject: [RESEND v7 15/37] clk: renesas: Add SH7750/7751 CPG Driver
Date: Thu,  4 Apr 2024 14:14:26 +0900
Message-Id: <0a30dbe6d096c38d612279349293162a2ccca149.1712207606.git.ysato@users.sourceforge.jp>
