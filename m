Return-Path: <linux-ide+bounces-4014-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 440E1B14063
	for <lists+linux-ide@lfdr.de>; Mon, 28 Jul 2025 18:35:04 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id BF32117EE4C
	for <lists+linux-ide@lfdr.de>; Mon, 28 Jul 2025 16:35:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3AB18274678;
	Mon, 28 Jul 2025 16:34:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="Lk3BO1f8"
X-Original-To: linux-ide@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.12])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8C5FC20ADF8
	for <linux-ide@vger.kernel.org>; Mon, 28 Jul 2025 16:34:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=192.198.163.12
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1753720472; cv=fail; b=P85VPrK6jCyT8FcZ53PC2zr0Pph36f+RetRP2BPO0NQhgE6ykmMd2KdmI8mqQMjOo6XK/rMEox4cKmTintYFQi1hj6AJ+nHWt8tCUUfPqGfi8zC4xaVoE9fkfboa4WpYWPgErZp7sX+KQQVdS0JxWaDhzRyzw/1MvcXQAX7symw=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1753720472; c=relaxed/simple;
	bh=qwibm1wvS1fcTpGRY0fbg6IFGgFUhLu/J3QjBxe10IA=;
	h=Message-ID:Date:Subject:To:CC:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=Zy2U8b89hr0WrnvpkLR51TwduhrFQTbCv9N2UoLWSOLsiwoY0f7TR26oD2RlqWlntFkgXZNCxnmWTwpfefD9DxBQN77qpvaKxfBmcgR0aDsAwFg1LvHzyeEy/NZyskb/aibz69fWNt2/llE5yJR0sn1mHc13Gum+znK/RHFQFLQ=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=Lk3BO1f8; arc=fail smtp.client-ip=192.198.163.12
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1753720470; x=1785256470;
  h=message-id:date:subject:to:cc:references:from:
   in-reply-to:content-transfer-encoding:mime-version;
  bh=qwibm1wvS1fcTpGRY0fbg6IFGgFUhLu/J3QjBxe10IA=;
  b=Lk3BO1f866cXkTNyfiVeZyf4h+shWKXWlhNJtbC0uAmO6zCH3+36173h
   1I/IfzmA4ndrUKqmJNgDDbTVbLFUV4EdqxozWPGQaU8jBOEaL+wRNh5cK
   7RDYwBzAbRI6AuHBlThyfS52UloB45aUUE6eDe9jHWU1lmhkwQAe6vhal
   I0D67oT5ScQxadTTcO8jIIxbH+BPr8Q2d6DjX+oPqpfrG9Ro0pdC7Ka2s
   A41S9taTwbadX0ypd+0BpKtwZKc9oE9GwrLVkFjDVqMkAOOTGOSAWnKHH
   yy4gGNdbTW92Pvygs+nLecBJH3qatF6WpvqdYaC1vdFaYtYN9Q6YdFq0q
   A==;
X-CSE-ConnectionGUID: MxaVtQuzS9eWLTVbxDYXZg==
X-CSE-MsgGUID: MsOBXyYSTWuTfu0ljyMQPg==
X-IronPort-AV: E=McAfee;i="6800,10657,11505"; a="59797417"
X-IronPort-AV: E=Sophos;i="6.16,339,1744095600"; 
   d="scan'208";a="59797417"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
  by fmvoesa106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Jul 2025 09:34:20 -0700
X-CSE-ConnectionGUID: GCN9Lso1RAGE/MiPlys3+w==
X-CSE-MsgGUID: YGGIDla2T+aj+0DiTsZEZA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.16,339,1744095600"; 
   d="scan'208";a="166946852"
Received: from orsmsx901.amr.corp.intel.com ([10.22.229.23])
  by orviesa004.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Jul 2025 09:34:20 -0700
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 28 Jul 2025 16:33:35.6170
 (UTC)
