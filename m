...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id BC93E1943DD
	for <lists+linux-ide@lfdr.de>; Thu, 26 Mar 2020 17:00:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727495AbgCZQAC (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Thu, 26 Mar 2020 12:00:02 -0400
Received: from mailout1.w1.samsung.com ([210.118.77.11]:58902 "EHLO
        mailout1.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728475AbgCZP6o (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Thu, 26 Mar 2020 11:58:44 -0400
Received: from eucas1p1.samsung.com (unknown [182.198.249.206])
        by mailout1.w1.samsung.com (KnoxPortal) with ESMTP id 20200326155842euoutp013aea6a19a426abf10bf44b46d1cd4622~-5dsVHenZ3025530255euoutp01E
        for <linux-ide@vger.kernel.org>; Thu, 26 Mar 2020 15:58:42 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout1.w1.samsung.com 20200326155842euoutp013aea6a19a426abf10bf44b46d1cd4622~-5dsVHenZ3025530255euoutp01E
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1585238323;
        bh=yxRc7TSWFnftzQGJHMYFF0qMNEs7OBUw7I4Q8LpyI8Q=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=k5q+RBriM2O0Cy28Pt6HqcVD+f0vDDY/uVWm5UyOdVqOKfFK4Lt2Ned4lpdlI/dL2
         TN6gnkwaHbn+D60ITXyE1nNBayuADcVyRRCHz+SlPfJakTaBpbr9ncTy+2TO0RpMMR
         zhpe8OLfIW24LHPxdaP/l4kvt7qRVfnDRsisSQXI=
Received: from eusmges3new.samsung.com (unknown [203.254.199.245]) by
        eucas1p1.samsung.com (KnoxPortal) with ESMTP id
        20200326155842eucas1p16f0f7a8e3f359c7f9db3d0a4b4c2d359~-5dsHOE4H0138201382eucas1p1G;
        Thu, 26 Mar 2020 15:58:42 +0000 (GMT)
Received: from eucas1p1.samsung.com ( [182.198.249.206]) by
        eusmges3new.samsung.com (EUCPMTA) with SMTP id 72.F7.60698.231DC7E5; Thu, 26
        Mar 2020 15:58:42 +0000 (GMT)
Received: from eusmtrp1.samsung.com (unknown [182.198.249.138]) by
        eucas1p1.samsung.com (KnoxPortal) with ESMTPA id
        20200326155842eucas1p16ec1dd1303741c202766ce6f1264df5d~-5drjT5Ik0942809428eucas1p1j;
        Thu, 26 Mar 2020 15:58:42 +0000 (GMT)
Received: from eusmgms1.samsung.com (unknown [182.198.249.179]) by
        eusmtrp1.samsung.com (KnoxPortal) with ESMTP id
        20200326155842eusmtrp120bb89343cd21d6f2f5ce7f24c14ac35~-5dritCtk2090020900eusmtrp1e;
        Thu, 26 Mar 2020 15:58:42 +0000 (GMT)
X-AuditID: cbfec7f5-a0fff7000001ed1a-91-5e7cd132741f
Received: from eusmtip1.samsung.com ( [203.254.199.221]) by
        eusmgms1.samsung.com (EUCPMTA) with SMTP id 7A.5A.08375.231DC7E5; Thu, 26
        Mar 2020 15:58:42 +0000 (GMT)
Received: from AMDC3058.digital.local (unknown [106.120.51.71]) by
        eusmtip1.samsung.com (KnoxPortal) with ESMTPA id
        20200326155841eusmtip17de289debaab5b8d57fe5e8eb74f33cb~-5drF6AcL0820308203eusmtip1g;
...
Subject: [PATCH v5 09/27] ata: move EXPORT_SYMBOL_GPL()s close to exported
 code
Date:   Thu, 26 Mar 2020 16:58:04 +0100
Message-Id: <20200326155822.19400-10-b.zolnierkie@samsung.com>
X-Mailer: git-send-email 2.24.1
In-Reply-To: <20200326155822.19400-1-b.zolnierkie@samsung.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Brightmail-Tracker: 
        ...
        
        mXZ7c2iQ8VHdn0osxRmJhlrMRcWJAJ6urqRDAwAA
X-Brightmail-Tracker: 
X-CMS-MailID: 20200326155842eucas1p16ec1dd1303741c202766ce6f1264df5d
X-Msg-Generator: CA
Content-Type: text/plain; charset="utf-8"
X-RootMTR: 20200326155842eucas1p16ec1dd1303741c202766ce6f1264df5d
X-EPHeader: CA
CMS-TYPE: 201P
X-CMS-RootMailID: 20200326155842eucas1p16ec1dd1303741c202766ce6f1264df5d
References: <20200326155822.19400-1-b.zolnierkie@samsung.com>
        <CGME20200326155842eucas1p16ec1dd1303741c202766ce6f1264df5d@eucas1p1.samsung.com>
