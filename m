Return-Path: <linux-ide+bounces-24-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id DC2087F13B7
	for <lists+linux-ide@lfdr.de>; Mon, 20 Nov 2023 13:43:23 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 963A1280291
	for <lists+linux-ide@lfdr.de>; Mon, 20 Nov 2023 12:43:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3A4C91A5B9
	for <lists+linux-ide@lfdr.de>; Mon, 20 Nov 2023 12:43:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=wdc.com header.i=@wdc.com header.b="cVn0m+OA";
	dkim=pass (1024-bit key) header.d=sharedspace.onmicrosoft.com header.i=@sharedspace.onmicrosoft.com header.b="SuZi0YxE"
...
CC: Sergey Shtylyov <s.shtylyov@omp.ru>, "Martin K . Petersen"
...
x-ms-exchange-antispam-messagedata-0:
 =?us-ascii?Q?Zjm7mqngBO9uNnlxBuFpET2PiCbt7IQMsCJLOEGCJyZhRvN95SEPwsNYpj8O?=
...
X-MS-Exchange-AntiSpam-ExternalHop-MessageData-0:
	=?us-ascii?Q?NACBtFnq5t9eyCt0zZ77UcmRPszYVmkNmmMFBFdavbX3U/MRnG593ld0DvNx?=
