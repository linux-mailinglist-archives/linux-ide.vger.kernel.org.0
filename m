Return-Path: <linux-ide+bounces-2223-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id A673696904E
	for <lists+linux-ide@lfdr.de>; Tue,  3 Sep 2024 01:07:24 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 6005E284AF4
	for <lists+linux-ide@lfdr.de>; Mon,  2 Sep 2024 23:07:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D62DA187860;
	Mon,  2 Sep 2024 23:07:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="ZOYPu3CV"
X-Original-To: linux-ide@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B25031428E8
	for <linux-ide@vger.kernel.org>; Mon,  2 Sep 2024 23:07:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1725318441; cv=none; b=Lpef66hg8hMejKV3GQq7lmlxHZz7J1Rr/p4ThySB8WmvddYAqT3pQ6CmqxWRSgWkSoavCsKiTG6nwfQ1P6gvCXoPHccDuassWseZT4dVMT/67pcvOWQJ9aUzoIZE/xz2hBFgs0Luy05pJULoXF31wPuWgmAVEIwxrbgJHVFK/G0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1725318441; c=relaxed/simple;
	bh=X9cnuJ85G8Oj8neinKFHm6RoVb6PNvT9xJvLWZ8rdiM=;
	h=From:To:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=GA+ATU/EwY7Nyy9vwKxbMYYlI2NvCfCtkUO+6mApABCwGdmoU3EPKkXa1BCY+M0/sramlnkn0llvoW+NI7bZWBoE2Y6ofYtIrrBkQwLlLfRU78yIfqyLU2bdVxobWgSaX2HBGpRntjjHAQ5uoTf54S+SowboRxHdZGjgq33IUFk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=ZOYPu3CV; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id D330AC4CEC2;
	Mon,  2 Sep 2024 23:07:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1725318441;
	bh=X9cnuJ85G8Oj8neinKFHm6RoVb6PNvT9xJvLWZ8rdiM=;
	h=From:To:Subject:Date:In-Reply-To:References:From;
	b=
From: Damien Le Moal <dlemoal@kernel.org>
To: linux-ide@vger.kernel.org,
	Niklas Cassel <cassel@kernel.org>
Subject: [PATCH v4 6/7] ata: libata: Move sector_buf from struct ata_port to struct ata_device
Date: Tue,  3 Sep 2024 08:07:14 +0900
Message-ID: <20240902230715.176522-7-dlemoal@kernel.org>
