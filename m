Return-Path: <linux-ide+bounces-2191-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id E8BA9967CDF
	for <lists+linux-ide@lfdr.de>; Mon,  2 Sep 2024 02:00:52 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 8D65A1F21611
	for <lists+linux-ide@lfdr.de>; Mon,  2 Sep 2024 00:00:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8ACD3EEC0;
	Mon,  2 Sep 2024 00:00:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="WtUJOH5H"
X-Original-To: linux-ide@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 65A2EEEB5
	for <linux-ide@vger.kernel.org>; Mon,  2 Sep 2024 00:00:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1725235250; cv=none; b=N3qb3D+V+/KQQKRGYhSbWqaRVFxMB00XEErbezpTvwjlA2iRXwjcFbxBuRBcYesWmSPiSxfSvcqbDiAX30g9aVEIfUtbiDxjqT0XbDkXmmR/L1Szp32WPQJCrtm2WKtSsMVcp26igh6Xv+7+GBdPTPEqgjIOC9rFkPog5M1R1R8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1725235250; c=relaxed/simple;
	bh=XGVzXDKGN4FI6C88Ul7zNsF904mGgvjPw2UI808otmA=;
	h=From:To:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=P3z0D4P6qOW6CkqFw7n5YaMZjGD2+RlBAVG7EYFdDP/BNwzCiiCpqah617zu60Qnetr7ZTDcoKPA8WC1USXpH+Ugbl29EoWGNY+LAhhjyJzS2rpao5LM7tHJ+9y8/CTFRvmTNRIotlnB5kjqQvkEE7m4vkxhXxwgs5btJb82avE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=WtUJOH5H; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 89CE9C4CEC8;
	Mon,  2 Sep 2024 00:00:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1725235250;
	bh=XGVzXDKGN4FI6C88Ul7zNsF904mGgvjPw2UI808otmA=;
	h=From:To:Subject:Date:In-Reply-To:References:From;
	b=
From: Damien Le Moal <dlemoal@kernel.org>
To: linux-ide@vger.kernel.org,
	Niklas Cassel <cassel@kernel.org>
Subject: [PATCH v2 5/7] ata: libata: Rename ata_eh_read_sense_success_ncq_log()
Date: Mon,  2 Sep 2024 09:00:41 +0900
Message-ID: <20240902000043.155495-6-dlemoal@kernel.org>
