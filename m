Return-Path: <linux-ide+bounces-4015-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 28DB9B1406C
	for <lists+linux-ide@lfdr.de>; Mon, 28 Jul 2025 18:37:47 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 374903AF06B
	for <lists+linux-ide@lfdr.de>; Mon, 28 Jul 2025 16:37:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8A1B3274671;
	Mon, 28 Jul 2025 16:37:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="FemkAPOW"
X-Original-To: linux-ide@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A861F273D95
	for <linux-ide@vger.kernel.org>; Mon, 28 Jul 2025 16:37:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=192.198.163.19
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1753720661; cv=fail; b=UqXCN1li+HoOBAcCxIe4T8qhNBVn+zWzK39MMTgJgP4l2arA/blbDz+7JxGicT/8+QkAYkw1Jv59Xjip9qa48rssqHmlHx6u0SW7E6MkDUYmWGIs63rIg5gyp44T23us312zfgb/X8OcI6PGLezUHApLcH8hBe8Rl6CmY5w0e5Y=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1753720661; c=relaxed/simple;
	bh=8kaa5VC2SkIqejbujamBx02+uo9DuEaeS1Qs0JDeYTc=;
	h=Message-ID:Date:Subject:To:CC:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=GjHBJBYu1+WgveRseCk4wjpNNkhybSLtT4+6bzuWN39jje9Gu/CXHIVWS6VUh2LvAIBV6v+YoAtSnFqXYFokimkjwurXf50zZ1k//rArNeOYwActMRCmnz/cjPr7wouc2R9kifmAxSJOG12e1N+Av/NfScpUNAXzTAQSJYrWmGg=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=FemkAPOW; arc=fail smtp.client-ip=192.198.163.19
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1753720660; x=1785256660;
  h=message-id:date:subject:to:cc:references:from:
   in-reply-to:content-transfer-encoding:mime-version;
  bh=8kaa5VC2SkIqejbujamBx02+uo9DuEaeS1Qs0JDeYTc=;
  b=FemkAPOWDY+nFY3dY5mJq0BHyacXwIawu6/HSur6S49g0LCuYCihPZXZ
   Y9SIaCiFM+bD7jFNC09KtfT5V9F1G/0ovtZDq5s1VMWEWhWlrhm03pavI
   Sm/x3qGI8OK/M6LIhL0TPG1Jygf1JH/hm/FX8c8hpPlWR1NCvFV0YPlC1
   mfvuEZsS6at0b66EiEK61IGfGjR7hZA+r52GXYx1og/gItRKtxxUY35UJ
   TO0kYa+c9GneeTRGB89FXGmONnGtJLtanSfIFn1fQPVXtZw/dpzaUHiFy
   Aa+Um85HlngDJ61nKJ033/N5zdtU9esSLphcFEAx/OuoC08mLmF0izTwl
   Q==;
X-CSE-ConnectionGUID: vVQs1MMJSrK7XKf5u4ZANg==
X-CSE-MsgGUID: 4dDGKd03TW2DA54j1SOtmQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11505"; a="55055489"
X-IronPort-AV: E=Sophos;i="6.16,339,1744095600"; 
   d="scan'208";a="55055489"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
  by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Jul 2025 09:37:39 -0700
X-CSE-ConnectionGUID: zXDgU9IfR3KHdBIvQlU+Xw==
X-CSE-MsgGUID: L6XqPeWdSSu3RMTXT1Sn7A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.16,339,1744095600"; 
   d="scan'208";a="193446627"
Received: from orsmsx901.amr.corp.intel.com ([10.22.229.23])
  by orviesa002.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Jul 2025 09:37:38 -0700
...
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:SJ1PR11MB6129.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230040)(1800799024)(376014)(366016)(7053199007);DIR:OUT;SFP:1101;
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 28 Jul 2025 16:37:21.0806
 (UTC)
