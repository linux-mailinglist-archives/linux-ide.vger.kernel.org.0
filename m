Return-Path: <linux-ide+bounces-4830-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id BBC4BCE5306
	for <lists+linux-ide@lfdr.de>; Sun, 28 Dec 2025 18:01:41 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id A8A7D300ACF5
	for <lists+linux-ide@lfdr.de>; Sun, 28 Dec 2025 17:01:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 946BD20E6E2;
...
Received: from mx0b-0031df01.pphosted.com (mx0b-0031df01.pphosted.com [205.220.180.131])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E697421ABB9
	for <linux-ide@vger.kernel.org>; Sun, 28 Dec 2025 17:01:27 +0000 (UTC)
...
Received: from pps.filterd (m0279871.ppops.net [127.0.0.1])
	by mx0a-0031df01.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id 5BSDARNs3110732
	for <linux-ide@vger.kernel.org>; Sun, 28 Dec 2025 17:01:27 GMT
...
Received: from mail-pf1-f198.google.com (mail-pf1-f198.google.com [209.85.210.198])
	by mx0a-0031df01.pphosted.com (PPS) with ESMTPS id 4ba71wtfg0-1
	(version=TLSv1.3 cipher=TLS_AES_128_GCM_SHA256 bits=128 verify=NOT)
	for <linux-ide@vger.kernel.org>; Sun, 28 Dec 2025 17:01:26 +0000 (GMT)
Received: by mail-pf1-f198.google.com with SMTP id d2e1a72fcca58-7ae3e3e0d06so7352700b3a.0
        for <linux-ide@vger.kernel.org>; Sun, 28 Dec 2025 09:01:26 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=JZpyQfB1E1Ukc3hXRUc/eOcDPD8SLuR+sl0Pk0A8isQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWyVSkWpZnCbBCdIyFiA1Q4zR3brMl05yW6MQ7hcidybmcMRlVbybcEQ4p4j4d99ftU8I8a1BNLsy8=@vger.kernel.org
X-Gm-Message-State: AOJu0YzyauA7VMjv7zWRl4GMcAaQIRYwZMffGDEz7VENecEtpc21Oy0M
	aqGO0RxGyXPI6RRY1sh0G3LQqH2gVjbTEZZ5x7hgA9q5UqjWEBtGuDHr0n57VtiVqxvlFQNbMWV
	C5X5uFxOcKYCeV6Rdj8hREO3xXZ+iPgqvaWrlJjr0lvqsWv7tBZS6oPuLjCcp4c0=
X-Gm-Gg: 
X-Received: by 2002:a05:6a00:bb91:b0:7e8:4471:8cc with SMTP id d2e1a72fcca58-7ff6627a17amr22970398b3a.45.1766941285762;
...
X-Proofpoint-Spam-Details-Enc: AW1haW4tMjUxMjI4MDE1NiBTYWx0ZWRfX7gjsTFFUnHin
 
X-Proofpoint-ORIG-GUID: 4xF3Y9UgaY8Sq3eF6uuArdRYB-bKfw_2
X-Proofpoint-GUID: 4xF3Y9UgaY8Sq3eF6uuArdRYB-bKfw_2
X-Authority-Analysis: v=2.4 cv=CK4nnBrD c=1 sm=1 tr=0 ts=69516266 cx=c_pps
