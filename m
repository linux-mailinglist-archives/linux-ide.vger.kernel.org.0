...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        ...
        b=g1EbONDuLB6lRf+opJv0zQFr0K2SBwGIMasOqoEFchfjyMJRvJ4P+JFPZqq5/XvcRAQtK3
        +W2kItDbb1zChPh+Hg5weY4LtAhwvX5vSbVV4k8AJMYiLvLu/ebZh7sp2jENM9oubo1YHj
        Gx+0wgtv2sw0+CEHVSq8F6+9uPuEZxM=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        ...
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         ...
         in-reply-to:in-reply-to:references:references;
        bh=Sf3w0y2mc1edHvbzk0IXn1FT2GK88csOMpOmsnmHypk=;
        b=XTcxDKxZlcPBBCQqdqMcS4ne99I/WG6afsmEYZWhz01gUbtkJwJmBasQh4j470vEcJlUzn
        IrINRbKYg/RheVDw==
Received: from adalid.arch.suse.de (adalid.arch.suse.de [10.161.8.13])
        by relay2.suse.de (Postfix) with ESMTP id AC06DA3BA9;
        Fri, 10 Dec 2021 07:29:18 +0000 (UTC)
Received: by adalid.arch.suse.de (Postfix, from userid 16045)
        id A846B5192047; Fri, 10 Dec 2021 08:29:18 +0100 (CET)
...
Date:   Fri, 10 Dec 2021 08:28:16 +0100
Message-Id: <20211210072905.15666-20-hare@suse.de>
