Return-Path: <linux-ide+bounces-3561-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 3F15FAB5150
	for <lists+linux-ide@lfdr.de>; Tue, 13 May 2025 12:12:43 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A44C01613EC
	for <lists+linux-ide@lfdr.de>; Tue, 13 May 2025 10:11:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 94DAC2512C6;
	Tue, 13 May 2025 10:07:52 +0000 (UTC)
X-Original-To: linux-ide@vger.kernel.org
Received: from invmail4.hynix.com (exvmail4.skhynix.com [166.125.252.92])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 23796242D7A;
	Tue, 13 May 2025 10:07:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=166.125.252.92
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1747130872; cv=none; b=IfikUk3KwkoDB8yhW03y6xcJXUofr1O7PoHEWt9Yc0BtijpuB0/hSDQNBXae1bgCTEY7RXrBJF7sYJ63u2U9WK4siukrLkv/BQnOzCmnNWb4vNUzOgdBQyMWp85aMIC8WYKwPcWOJC+kM1F5KavXiNs0x8PKVt6QTZyUgAOirVQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1747130872; c=relaxed/simple;
	bh=r9AOmCuG9olXiJLIoeJcAKKVSNJf9gWYAwWvkyMyvIU=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References; b=af1ldlo9qo8GoQx6XMCnvmIYjB7xlBIenNUweYgG3crtLtFn7NqjQ4J/Z8koWKtbpMpKSM7k5/cRN9AOjVCPgtoFalPuu+iO6/6iIzgsYm2vvNZWkCKH8n0NqesA01Iq2HFO4fh6YiGqbtq+7OtPUR6v3T4Xsfmg9+kkxY2f4vY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com; spf=pass smtp.mailfrom=sk.com; arc=none smtp.client-ip=166.125.252.92
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=sk.com
X-AuditID: a67dfc5b-669ff7000002311f-e9-682319ed136a
...
Subject: [PATCH v15 02/43] dept: implement DEPT(DEPendency Tracker)
Date: Tue, 13 May 2025 19:06:49 +0900
Message-Id: <20250513100730.12664-3-byungchul@sk.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20250513100730.12664-1-byungchul@sk.com>
References: <20250513100730.12664-1-byungchul@sk.com>
X-Brightmail-Tracker: 
	fXnqWf5qi7N44VgAESkjYxTy0GBCHSP/DYvpgTJbAwAA
X-Brightmail-Tracker: 
