Return-Path: <linux-ide+bounces-4499-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from ams.mirrors.kernel.org (ams.mirrors.kernel.org [213.196.21.55])
	by mail.lfdr.de (Postfix) with ESMTPS id 03B44BB5D3E
	for <lists+linux-ide@lfdr.de>; Fri, 03 Oct 2025 04:44:53 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.mirrors.kernel.org (Postfix) with ESMTPS id 3D7313445DF
	for <lists+linux-ide@lfdr.de>; Fri,  3 Oct 2025 02:44:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A78682DF14E;
...
Received: from mail-pl1-f173.google.com (mail-pl1-f173.google.com [209.85.214.173])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8F5242DE711
	for <linux-ide@vger.kernel.org>; Fri,  3 Oct 2025 02:44:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1759459481; cv=none; b=ButQgCF0pD1RX164/3ov8RhIXkaTsmK0YxaTLX3B/VJ/ZaUJRWDqM6jyUzNpqyookMrlabY5YiEQDtBvo/cSRQ1cqkOtJLSnfbMGWf1D9GMJJYsZSISRrEcSJQh9uxKNqvE86fkNzdQFvrv0/Rggv8A68kgPMLTiwiI0LXewjWs=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1759459481; c=relaxed/simple;
	bh=ssNDj1nyve9l9BTdjQ/zgSqvViNlIcvrKmJ1owlymm4=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=YlmXzvsphqXZS812RUblULDmWDAwlO8T2E8Z+1QlDdfTcLebU6zKj+V3NZW3eNXf1yyTC8uIvso7xDBPgt2sAN9MQzA6rtq7OnyJakukBiXOXcrUsEHo/rJXF3nzskfimcM1N1olgniCTrpDr3LIId7/KVialwfvJNnDkcDmguc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=a+U6JGKo; arc=none smtp.client-ip=209.85.214.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-pl1-f173.google.com with SMTP id d9443c01a7336-26e68904f0eso18025445ad.0
        for <linux-ide@vger.kernel.org>; Thu, 02 Oct 2025 19:44:33 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=qetHx9HVdf2g3s5a7dZOmiU3bkwsi2YCKNcOlkRT3So=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCX2xvWzy1JMhd2ITDmrp1mDdCR4x3spkH9eGNENmEoHquqSqbambl0gdt4Z4XSUR7xuUUGxeBCzqMs=@vger.kernel.org
X-Gm-Message-State: AOJu0YwhiNOyJ6/01MX1uZ/ZZAYCsjHND4RA8wJOAQxrQNCwSy1rijQa
	COfbm2Ysm0u28h+dO24FLyfdjtRIjZQw9erYVwEEwESwzgGsfCHvVEMh
X-Gm-Gg: 
