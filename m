...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 738EE676394
	for <lists+linux-ide@lfdr.de>; Sat, 21 Jan 2023 05:01:52 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229636AbjAUEBv (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Fri, 20 Jan 2023 23:01:51 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58574 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229464AbjAUEBu (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Fri, 20 Jan 2023 23:01:50 -0500
Received: from mail-qt1-x831.google.com (mail-qt1-x831.google.com [IPv6:2607:f8b0:4864:20::831])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9202B73AF4;
        Fri, 20 Jan 2023 20:01:44 -0800 (PST)
Received: by mail-qt1-x831.google.com with SMTP id h24so1855203qta.12;
        Fri, 20 Jan 2023 20:01:44 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=3VTwKNjXL/4Nmclcq3CBSxIztAnhBoLkdS56KIQhnLI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=3VTwKNjXL/4Nmclcq3CBSxIztAnhBoLkdS56KIQhnLI=;
        b=
X-Gm-Message-State: AFqh2krZdtDl806WIuYlJJZsQLRPkpe32vWwi8cWHVEfrP9F7u/XLFMt
        UgtQqm+C67nIsGvNCHX3nFc=
X-Google-Smtp-Source: AMrXdXu7g1X/V7fGiSXtxrMvxIn06jmZuOGhWOV+QsRArON7D6i3Ko/9vR90jxEdC8/IIIojH0298w==
X-Received: by 2002:ac8:688d:0:b0:3b6:2fba:3d46 with SMTP id m13-20020ac8688d000000b003b62fba3d46mr25761200qtq.42.1674273703533;
        Fri, 20 Jan 2023 20:01:43 -0800 (PST)
Received: from auth1-smtp.messagingengine.com (auth1-smtp.messagingengine.com. [66.111.4.227])
        by smtp.gmail.com with ESMTPSA id 3-20020a05620a070300b00706b69d3414sm6037956qkc.94.2023.01.20.20.01.42
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 20 Jan 2023 20:01:42 -0800 (PST)
Received: from compute6.internal (compute6.nyi.internal [10.202.2.47])
        by mailauth.nyi.internal (Postfix) with ESMTP id 1EBB327C0054;
        Fri, 20 Jan 2023 23:01:42 -0500 (EST)
Received: from mailfrontend2 ([10.202.2.163])
  by compute6.internal (MEProxy); Fri, 20 Jan 2023 23:01:42 -0500
X-ME-Sender: <xms:o2PLY-2XNcboCNqj7Ai_XVFxumbULVU7l6xiHLq0uVQDFo9YOkGVPw>
    <xme:o2PLYxG6wmfxEsCKyFjSR8KKg0Y7dPnBzEjzZOX6F_c10fRkiZECu91wNxxwvTkQl
    jRvddCMKBq87Y50Vg>
X-ME-Received: <xmr:o2PLY27XIF5Oz2XLyuKFdPbVQnaj1GiPFtfBRZHDlFpw0OW5iAsPNAK1Yzc>
X-ME-Proxy-Cause: 
    rghmvg
X-ME-Proxy: <xmx:pGPLY_3509cpjcCs91HyZ1wrpgDMZNP39kPhK5EVd6KKKGajfyPqYg>
    <xmx:pGPLYxGDWm8hxPxnluM88_3EPlb6JF7iR-SmQeOTG17-WdHqKpMn9w>
    <xmx:pGPLY4-w3c1xqBlB8RWd2U9XKdbmcp1dMQ89qkP_7QaVatQ2xrUemA>
    <xmx:pmPLYx_B9XX7iGXALpAttuGD40_pHdfmfydHK0JejypJvjSHh-biKzEKLRc>
Feedback-ID: iad51458e:Fastmail
Received: by mail.messagingengine.com (Postfix) with ESMTPA; Fri,
 20 Jan 2023 23:01:39 -0500 (EST)
...
References: <Y8oFj9A19cw3enHB@boqun-archlinux>
 ...
 <Y8tfgYNZ//feEDvC@Boquns-Mac-mini.local>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="MQwSjKvHNSak5zRt"
...
# Linux/x86 6.2.0-rc2 Kernel Configuration
#
...
#
CONFIG_DEPT=y
# CONFIG_DEPT_AGGRESSIVE_TIMEOUT_WAIT is not set
