...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 221F44D56B6
	for <lists+linux-ide@lfdr.de>; Fri, 11 Mar 2022 01:27:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238705AbiCKA2z (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Thu, 10 Mar 2022 19:28:55 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52118 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238200AbiCKA2u (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Thu, 10 Mar 2022 19:28:50 -0500
Received: from esa3.hgst.iphmx.com (esa3.hgst.iphmx.com [216.71.153.141])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 76D0A7666E
        for <linux-ide@vger.kernel.org>; Thu, 10 Mar 2022 16:27:45 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=wdc.com; i=@wdc.com; q=dns/txt; s=dkim.wdc.com;
  t=1646958464; x=1678494464;
  h=message-id:date:mime-version:subject:to:cc:references:
   from:in-reply-to:content-transfer-encoding;
  bh=Wf3uB4RivwB3BmzglqEEdO3LkPIJmT5PJhaP+VR4c5A=;
  b=bbOXBg4Jg5MRrlJE9yZKnsy0NqEkuMvX5keI2W0nPFXRkf+CWQWmgFhh
   ySxXSQwNOPsH2D6VaBmXOws4YRs6Ef0Xk1gIM984aURSOiNSye+vMn8pO
   M5UOK9GJuHyoPrHd8Ot/cGcH1q6paa4tb8fBU/Ga0f6oDtXkgauoz4XE1
   K+/+HtWpEuW2qkanpndtPtRqDpgPpG3GlDECVNah7c1H85W8TtxNuTRdn
   1k2+5HGWJbK1yEe02MwD5f6p2oPHh6sGz7bUERtKGlEBDiNj8GRnC8B9K
   5U8YZ2jldFgVqtkhJXhYi8AECyzdSiayYFtJZidIPQBJZUg+AtTb3vInp
   w==;
X-IronPort-AV: E=Sophos;i="5.90,172,1643644800"; 
   d="scan'208";a="199858923"
Received: from uls-op-cesaip01.wdc.com (HELO uls-op-cesaep01.wdc.com) ([199.255.45.14])
  by ob1.hgst.iphmx.com with ESMTP; 11 Mar 2022 07:59:26 +0800
IronPort-SDR: 
 szC1ZPg1tcxEGiIXwn3Kde8k
Received: from uls-op-cesaip02.wdc.com ([10.248.3.37])
  by uls-op-cesaep01.wdc.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Mar 2022 15:31:39 -0800
IronPort-SDR: 
...
Received: from usg-ed-osssrv.wdc.com (usg-ed-osssrv.wdc.com [127.0.0.1])
        by usg-ed-osssrv.wdc.com (Postfix) with ESMTP id 4KF5dV45Mgz1SVp3
        for <linux-ide@vger.kernel.org>; Thu, 10 Mar 2022 15:59:26 -0800 (PST)
...
Received: from usg-ed-osssrv.wdc.com ([127.0.0.1])
        ...
        with ESMTP id nDAoa_U-QuA4 for <linux-ide@vger.kernel.org>;
