Return-Path: <linux-ide+bounces-4020-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 3EBFFB14A4D
	for <lists+linux-ide@lfdr.de>; Tue, 29 Jul 2025 10:43:43 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 7B18A3BF1FA
	for <lists+linux-ide@lfdr.de>; Tue, 29 Jul 2025 08:43:13 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 76DB62857CD;
	Tue, 29 Jul 2025 08:43:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="WKOjTQRo"
X-Original-To: linux-ide@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.17])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CE85C2AF1C
	for <linux-ide@vger.kernel.org>; Tue, 29 Jul 2025 08:43:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=198.175.65.17
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1753778617; cv=fail; b=CZh9rE8kU86Cq8qNQOr8HGamoW4psDasgGzjcpKiXUB03Ujd2oexAkGYT5bOezVAOUOTPldZBGmTocVTJDyunFw4WtpIGgwl+QI6rmb4LNV03XW3hUYqq2yCWPWhS80EqcMlT9nhyzmsXX2voDbZfmiC7C96VoC123HHboh1i7E=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1753778617; c=relaxed/simple;
	bh=1fHG7fLsXjMzvBzN37UpDm6Pl0BqTje+viWh/b9W3XA=;
	h=Message-ID:Date:Subject:To:CC:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=MFrSM8dVgz1lCFl2aRFbNVaEHmTLhR1sS6geoaCdin4spMJ6vRUJ244NZVwJ4bBuYXH64W8aBrSwkL8M1o66X9nf1S9RaZwYcEmZRk45V0HN39PEr1O2tkDuP//1/tOe8zZa1xq+AYrjSq98aJStbW11yiv42T05zCUgiPmD9Cg=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=WKOjTQRo; arc=fail smtp.client-ip=198.175.65.17
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=WKOjTQRol3lZ16ZVkqq7tHN4NpJRPnVhACzxq36sjxFC/M0SjZDRJBTs
   ...
   sOQPAOHuIrNTwxw/ElLFmBrV/sTT55ts6vAvfZqiCfz2UivcqITkFX4pG
   g==;
X-CSE-ConnectionGUID: nGL53JkXS6evmx0rVh2EEQ==
X-CSE-MsgGUID: y9Hk7uNoRCSJpbsAJzcOXg==
X-IronPort-AV: E=McAfee;i="6800,10657,11505"; a="56012334"
X-IronPort-AV: E=Sophos;i="6.16,348,1744095600"; 
   d="scan'208";a="56012334"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
  by orvoesa109.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Jul 2025 01:43:36 -0700
X-CSE-ConnectionGUID: YsrU3XTsQsO9EdLodCQXiQ==
X-CSE-MsgGUID: V2r4WAobTyaWBKo0LBIqQw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.16,348,1744095600"; 
   d="scan'208";a="186296061"
Received: from orsmsx901.amr.corp.intel.com ([10.22.229.23])
  by fmviesa002.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Jul 2025 01:43:35 -0700
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 29 Jul 2025 08:43:30.7119
 (UTC)
