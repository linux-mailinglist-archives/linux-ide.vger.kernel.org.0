Return-Path: <linux-ide+bounces-2792-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FAE29E965E
	for <lists+linux-ide@lfdr.de>; Mon,  9 Dec 2024 14:19:19 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 22DE41883E9D
	for <lists+linux-ide@lfdr.de>; Mon,  9 Dec 2024 13:16:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 43A76225A89;
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B5D15222D7B
	for <linux-ide@vger.kernel.org>; Mon,  9 Dec 2024 13:07:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1733749639; cv=none; b=HT3lkfwkCGn/qvO/7GS3m/+VwPU1JfumS3CotWkhHqqPQ0WIY5omMSZQGNdvV0OiRGPfRy+jReq/xr33QzCn3yst/bCbT8CiVmEQJPoAtsfWBuL6w5yrcsbo0yhsSId46+a0EFISilOayyFZ06LvouYYo4IxZxPFkwy7AcMMGBU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1733749639; c=relaxed/simple;
	bh=iQxm4QfjlR4Q7L78H1eAEsRALrLF6d6wl8eA0eVuu8s=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=XoBw/vdg4FHqKdJkB5iBWlFBQp0NU8ls41k9TyG1xsUtEK5AP0ci5ky0u5Tw1b20qUor9ziuQ8X+B3fDsZE05QTXKBVdc/qVE2bzc0iRBoLqFoHF9NJQA1MadifstVr/SLH0f9o9BWK5GOUs0MPW1q+rWa6l+SkeECtGQeYpqwA=
...
Received: from mail-wm1-f72.google.com (mail-wm1-f72.google.com
 ...
 us-mta-684-O828Eki6MKmtGc3cQAfAqg-1; Mon, 09 Dec 2024 08:07:13 -0500
X-MC-Unique: O828Eki6MKmtGc3cQAfAqg-1
X-Mimecast-MFC-AGG-ID: O828Eki6MKmtGc3cQAfAqg
Received: by mail-wm1-f72.google.com with SMTP id 5b1f17b1804b1-434f1af9d31so8488665e9.2
        for <linux-ide@vger.kernel.org>; Mon, 09 Dec 2024 05:07:13 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=6HNQFFZFNBo2fKXDk5eFuu7P7NBI6b9tUTkzIaFtOWU=;
        b=
X-Gm-Message-State: AOJu0YyybWXfIeC9uq7pR+V8qzq2RiD1msMJqn9Uo/Job36E48O3WBTm
	Q2BX1YUBqwYl3jHpPFQLZFGqqzCGtaGCsIijepoux3kF8O2stuOAJGO8B5yV0gN1GHhSLRa3dIC
	pPMHitaO/tlipvGr14RUBDTj0kjjTizZd+qN0ueII8KvAQHyql/nP4QkV9Q==
X-Gm-Gg: 
	ARXfjtUj
X-Received: by 2002:a05:600c:3547:b0:434:a525:7257 with SMTP id 5b1f17b1804b1-434fffd0490mr3116245e9.21.1733749630813;
