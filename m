Return-Path: <linux-ide+bounces-4765-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id E7104CA6A18
	for <lists+linux-ide@lfdr.de>; Fri, 05 Dec 2025 09:13:08 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 53AFB335BE7E
	for <lists+linux-ide@lfdr.de>; Fri,  5 Dec 2025 07:57:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9EF073446D6;
	Fri,  5 Dec 2025 07:21:56 +0000 (UTC)
X-Original-To: linux-ide@vger.kernel.org
Received: from invmail4.hynix.com (exvmail4.skhynix.com [166.125.252.92])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 72E192DE6F9;
	Fri,  5 Dec 2025 07:20:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=166.125.252.92
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764919315; cv=none; b=gfA1ip8HOmSi+u3zGGJHCYoRBQhy1hHjW6B5be4QLUI3/DgY7maUCzFthMupGRJ3QzF4ZbDprrK8BrBD/Fnlqa3eC+Y/SDAOwSxqEQj3gOxKBql0hNrfMmS/7U1H4/2Ag+eNmH8wQl4Kfv2uIsQSmG4EYlhYZK3hRMV3bvDkKjA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764919315; c=relaxed/simple;
	bh=FliTVDSIpAU7z4bwrrHFuint8+3hA0BBDhmYa2LwLLQ=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References; b=FvZbio4+zMSvO0waCXyBk4eVFyU91Y/xodlg7j04NGLNOJJqdEH1xRhJHHppASAWIa0BO0yJlVkwLscOnMAIExG3b+Sfa4tzMyZ0ngPevT0ASk+vo1W47XwlorOzIpVkHgp+N24/WYSNgYljclYSHHI8TW5FoIw6KdMXqckZAMY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com; spf=pass smtp.mailfrom=sk.com; arc=none smtp.client-ip=166.125.252.92
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=sk.com
X-AuditID: a67dfc5b-c2dff70000001609-f2-69328770eb37
...
X-Brightmail-Tracker: 
