Return-Path: <linux-ide+bounces-324-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 3AB5483A8C3
	for <lists+linux-ide@lfdr.de>; Wed, 24 Jan 2024 13:02:23 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 4EAC6B23FE0
	for <lists+linux-ide@lfdr.de>; Wed, 24 Jan 2024 12:02:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5E3BD62A0E;
	Wed, 24 Jan 2024 12:00:05 +0000 (UTC)
X-Original-To: linux-ide@vger.kernel.org
Received: from invmail4.hynix.com (exvmail4.hynix.com [166.125.252.92])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2EA4B60DC4;
	Wed, 24 Jan 2024 11:59:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=166.125.252.92
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706097605; cv=none; b=nbTQOmjACG5HiPC2FfFY2rSCoDN77x2E2YyUH/4dUkUHDaYWNg+i/OTfAmjrVQR47OpoUystYwzcEDag73Em2lVvZEDJh1msT7fWraPylnn8u6iyxf/bo52T4QlDTxh2RWnYwH1evEuN5a+FqrGfRt4w147RREiLNorWXQe+rUA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706097605; c=relaxed/simple;
	bh=asSKRbIQNcB08UYPRwv3bUSMHrCIvUqTNtShomc8xTg=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References; b=MbfEn/bs9NGZfzbc/BFBjyLDV2GL9OAYL4vGZq/ul50oWfZiYKGmWwq/psns3kz6RVHJ+FuHrKi3mMs0heMyt5nXCjJ6AK2Ij9KGF3h/f3BFFDJNaDUCllHXcwlDxhnyMCoKsLQtWOY8bBHI6TtHQ6Pdz8WlbPK/yqG9A9ocHuM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com; spf=pass smtp.mailfrom=sk.com; arc=none smtp.client-ip=166.125.252.92
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=sk.com
X-AuditID: a67dfc5b-d85ff70000001748-61-65b0fbb469ad
...
Subject: [PATCH v11 02/26] dept: Implement Dept(Dependency Tracker)
Date: Wed, 24 Jan 2024 20:59:13 +0900
Message-Id: <20240124115938.80132-3-byungchul@sk.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20240124115938.80132-1-byungchul@sk.com>
References: <20240124115938.80132-1-byungchul@sk.com>
X-Brightmail-Tracker: 
X-Brightmail-Tracker: 
	z7AyAwAA
...
index 292c31697248..6dafdc93b462 100644
...
@@ -1178,6 +1179,8 @@ struct task_struct {
...
index 5727d42149c3..171572fbdb43 100644
--- a/init/init_task.c
+++ b/init/init_task.c
@@ -12,6 +12,7 @@
...
index e24b0780fdff..39dac78fafc1 100644
--- a/init/main.c
+++ b/init/main.c
@@ -65,6 +65,7 @@
...
@@ -1011,6 +1012,7 @@ void start_kernel(void)
 		      panic_param);
...
index 3947122d618b..e864b66d6470 100644
--- a/kernel/Makefile
+++ b/kernel/Makefile
...
index aedc0832c9f4..32b7f551674b 100644
--- a/kernel/exit.c
+++ b/kernel/exit.c
...
index 10917c3e1f03..2f1f5dbec154 100644
--- a/kernel/fork.c
+++ b/kernel/fork.c
@@ -99,6 +99,7 @@
...
+#include <linux/dept.h>
 ...
 #include <linux/uaccess.h>
@@ -2455,6 +2456,7 @@ __latent_entropy struct task_struct *copy_process(
...
index 98fedfdb8db5..507c73b10258 100644
...
@@ -3020,6 +3022,8 @@ static int load_module(struct load_info *info, const char __user *uargs,
...
index a708d225c28e..e2a7ee076a58 100644
...
@@ -4197,6 +4198,8 @@ int try_to_wake_up(struct task_struct *p, unsigned int state, int wake_flags)
 	guard(preempt)();
 	int cpu, success = 0;
...
@@ -6578,6 +6581,12 @@ static void __sched notrace __schedule(unsigned int sched_mode)
 	rq = cpu_rq(cpu);
 	prev = rq->curr;
...
@@ -6691,6 +6700,7 @@ static void __sched notrace __schedule(unsigned int sched_mode)
...
index 4405f81248fb..9602f41ad8e8 100644
--- a/lib/Kconfig.debug
+++ b/lib/Kconfig.debug
@@ -1285,6 +1285,33 @@ config DEBUG_PREEMPT
