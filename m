...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2E9C775CF77
	for <lists+linux-ide@lfdr.de>; Fri, 21 Jul 2023 18:35:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229771AbjGUQfR (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Fri, 21 Jul 2023 12:35:17 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60960 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230398AbjGUQfG (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Fri, 21 Jul 2023 12:35:06 -0400
Received: from mail-lj1-x22e.google.com (mail-lj1-x22e.google.com [IPv6:2a00:1450:4864:20::22e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8BEA53583;
        Fri, 21 Jul 2023 09:34:36 -0700 (PDT)
Received: by mail-lj1-x22e.google.com with SMTP id 38308e7fff4ca-2b6f0508f54so31933631fa.3;
        Fri, 21 Jul 2023 09:34:36 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1689957265; x=1690562065;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:dkim-signature:dkim-signature
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=tu7qcyNn/lykfEDtL2goTtjfOS2WRqg/61tO+xyVpX4=;
        b=
X-Gm-Message-State: ABy/qLZEgpCyEyJxGAWrWq2QSyzSHcclHyoUkKgmIxPOS4pCVmm20P2d
        DxDy5Nt7xpe0CvjqQNBsKW+pA4Mgji7pEQ==
X-Google-Smtp-Source: APBJJlEQj5Uxm2BibsNM2gWvdj7zoxRUFTi1/c9zGi1id5OMD0TRsXi1ORvkRazGe+5dCp2G5moc+A==
X-Received: by 2002:a2e:8607:0:b0:2b6:f85a:20b0 with SMTP id a7-20020a2e8607000000b002b6f85a20b0mr1941583lji.16.1689957265206;
        Fri, 21 Jul 2023 09:34:25 -0700 (PDT)
Received: from flawful.org (c-f5f0e255.011-101-6d6c6d3.bbcust.telenor.se. [85.226.240.245])
        by smtp.gmail.com with ESMTPSA id x11-20020a2e880b000000b002b6ea79c613sm1020735ljh.94.2023.07.21.09.34.24
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 21 Jul 2023 09:34:24 -0700 (PDT)
Received: by flawful.org (Postfix, from userid 112)
        id EE2233F57; Fri, 21 Jul 2023 18:34:23 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=flawful.org; s=mail;
        t=1689957264; bh=s7MDQwUko5FWn2RTAVQpElgQmcuPgKA2vBf07IXTe5g=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=I6Kbw9NWF6+W6Axgs9piwDDD2/QjHGKLJmZ+gAzoygV9jKb4N0QOCBpiXm5NlMOal
         cdKgQmj4lpT+jmnzCkb9AD4x6gx9VaQBxW19kIIKI2yEWLsuWt+SEF6HDT3lo4Zk6G
         nAtNZfQQtzwMRg2aqNOhV7/XibCIA89eBcBg1TjE=
...
Received: from x1-carbon.lan (OpenWrt.lan [192.168.1.1])
        ...
        by flawful.org (Postfix) with ESMTPSA id ACF1D3F2A;
        Fri, 21 Jul 2023 18:32:50 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=flawful.org; s=mail;
        t=1689957171; bh=s7MDQwUko5FWn2RTAVQpElgQmcuPgKA2vBf07IXTe5g=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=tGW9qv8L4leVob3LTJboo9cCR7x+gDuz9Mi25QhjSUqi1EDshvVnHrAG6EuJB3z5r
         gUFKjUFEleloy5cfSlwYG1UTxkKLLzx7v8MuyrSTQ584qk6n6rTVaoqbmL18QaY42P
         pubi9NvwuLPNY9acP9mRmnjqIJkBXRazbCZBgjng=
...
Subject: [PATCH v3 1/9] ata: remove reference to non-existing error_handler()
Date:   Fri, 21 Jul 2023 18:32:12 +0200
Message-ID: <20230721163229.399676-2-nks@flawful.org>
...
index 35e03679b0bf..9d6affabf225 100644
...
index 370d18aca71e..9111d1b3c586 100644
