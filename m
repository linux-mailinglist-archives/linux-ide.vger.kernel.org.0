...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 957047458E1
	for <lists+linux-ide@lfdr.de>; Mon,  3 Jul 2023 11:49:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231348AbjGCJtz (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Mon, 3 Jul 2023 05:49:55 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50146 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231266AbjGCJtv (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Mon, 3 Jul 2023 05:49:51 -0400
Received: from invmail4.hynix.com (exvmail4.skhynix.com [166.125.252.92])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 3CC7CDD;
        Mon,  3 Jul 2023 02:49:40 -0700 (PDT)
X-AuditID: a67dfc5b-d85ff70000001748-f5-64a299b224b4
...
Subject: [PATCH v10 rebased on v6.4 02/25] dept: Implement Dept(Dependency Tracker)
Date:   Mon,  3 Jul 2023 18:47:29 +0900
Message-Id: <20230703094752.79269-3-byungchul@sk.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20230703094752.79269-1-byungchul@sk.com>
References: <20230703094752.79269-1-byungchul@sk.com>
X-Brightmail-Tracker: 
        pX5zS0F9SK6CToxWLg2mNInKf+HhpnNPAwAA
X-Brightmail-Tracker: 
