Return-Path: <linux-ide+bounces-4770-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id BA7FBCA9E00
	for <lists+linux-ide@lfdr.de>; Sat, 06 Dec 2025 03:07:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id D15DA32868C5
	for <lists+linux-ide@lfdr.de>; Sat,  6 Dec 2025 02:02:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 735F9253F05;
	Sat,  6 Dec 2025 02:02:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="dXiGCKoG"
X-Original-To: linux-ide@vger.kernel.org
Received: from mail-qk1-f195.google.com (mail-qk1-f195.google.com [209.85.222.195])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8D5FA244675
	for <linux-ide@vger.kernel.org>; Sat,  6 Dec 2025 02:02:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.222.195
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764986552; cv=none; b=QaXluXLFCB63Y0U7hh1NgR951+ypjVA/Kz9gNXoEnPCLUcIHsshVuqcpRoqEq+XjbAWDUVo5RnYTodrb6TJFrj/2KauTRA4TbrGxS1ADWmssUkOyWWnuTDWQiKtIAE5IHMdy7GCrudmkGRraGGxolDri7piiUm3nUw1cQ/TiC1A=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764986552; c=relaxed/simple;
	bh=Iy/dC9DMvwJJmRWZMLpi4XZSdwVA9s5IWC+8sP211f4=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=mGdaFOZ0b2fMCCvFRP5K4XsefftFthqVsi5I6jegfyOZP0bRsxHp3U3KFqRTEQ0u2p9O2Dnm0qrlacti/fSKzHPBrIEbsLy1n8Q3cjVx0rIeL6FNN1GO/kdaPOjItQJv62LJBsW+gT81osXe5iC8RyLGhGgkadPafFALt/q8BRg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=dXiGCKoG; arc=none smtp.client-ip=209.85.222.195
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-qk1-f195.google.com with SMTP id af79cd13be357-8b2148ca40eso362176085a.1
        for <linux-ide@vger.kernel.org>; Fri, 05 Dec 2025 18:02:30 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1764986549; x=1765591349; darn=vger.kernel.org;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:from:to:cc:subject:date:message-id:reply-to;
        bh=ikbW0KTFV2Hrw3Ofr3+X6/ogNZDuDLj9J6B0i4MyxZI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1764986549; x=1765591349;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:x-gm-gg:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=ikbW0KTFV2Hrw3Ofr3+X6/ogNZDuDLj9J6B0i4MyxZI=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUg+Vtn68DYc3uaSP6YFWBrfTSLfkMVX1MfJ7KuwlXgW88+Y57Ij8URN3Gu4e/5x+t23lKRD1F4Fw4=@vger.kernel.org
X-Gm-Message-State: AOJu0YyZ38mppy0EmoeWq/y+dyfdpbqDbcjfg4ZNPZZp580Pi52fs8dP
	JQzbFeO8jJ92QjExD6Mkql73W/1KVnNdHGryTuUGMahX+syavnOubEBI
X-Gm-Gg: 
