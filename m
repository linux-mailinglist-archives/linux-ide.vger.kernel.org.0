...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 82E1E572D62
	for <lists+linux-ide@lfdr.de>; Wed, 13 Jul 2022 07:34:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234556AbiGMFde (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Wed, 13 Jul 2022 01:33:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43436 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234270AbiGMFbj (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Wed, 13 Jul 2022 01:31:39 -0400
Received: from mail.baikalelectronics.com (mail.baikalelectronics.com [87.245.175.230])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 3489DBB7F1;
        Tue, 12 Jul 2022 22:29:55 -0700 (PDT)
Received: from mail (mail.baikal.int [192.168.51.25])
        by mail.baikalelectronics.com (Postfix) with ESMTP id A2E5116D2;
        Wed, 13 Jul 2022 08:31:38 +0300 (MSK)
DKIM-Filter: OpenDKIM Filter v2.11.0 mail.baikalelectronics.com A2E5116D2
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=baikalelectronics.ru; s=mail; t=1657690298;
        bh=lDcRQOupurGl9U+SDf0GXbEwoE/FFNVKq3sLGlaJaV0=;
        h=From:To:CC:Subject:Date:In-Reply-To:References:From;
        b=SyYotggxyYhkDxoeg/lxmmL4vH87caS5IIfMXWTYgIoYNVqMNDnS4rCd+5wcV4pQP
         HzvLbFaKMHIwkoEJXJ97xXdrO33xPTeKhIPk9mxvljlMhid15mDd6qBwPWgccmsPu2
         FLBxWbc6CKCWb3i8mdWdjKJdEjFt7OHAIKIqlIQc=
Received: from localhost (192.168.53.207) by mail (192.168.51.25) with
 Microsoft SMTP Server (TLS) id 15.0.1395.4; Wed, 13 Jul 2022 08:29:42 +0300
...
Subject: [PATCH v5 19/23] ata: ahci: Add DWC AHCI SATA controller support
Date:   Wed, 13 Jul 2022 08:29:12 +0300
Message-ID: <20220713052917.27036-20-Sergey.Semin@baikalelectronics.ru>
...
index 000000000000..96d73a4de510
--- /dev/null
