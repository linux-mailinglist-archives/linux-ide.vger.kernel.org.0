Return-Path: <linux-ide+bounces-3671-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A268ABB8D0
	for <lists+linux-ide@lfdr.de>; Mon, 19 May 2025 11:22:12 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 8EB123ABDD3
	for <lists+linux-ide@lfdr.de>; Mon, 19 May 2025 09:21:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7BEFA274676;
	Mon, 19 May 2025 09:18:54 +0000 (UTC)
X-Original-To: linux-ide@vger.kernel.org
Received: from invmail4.hynix.com (exvmail4.hynix.com [166.125.252.92])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 366CC26C399;
...
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	...
	bh=LpRXz0duwc4dLoAx4URhdlf+u3eO/CuCSmsA+pRZdFc=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References; b=dYdwNB9up5o6JBSdKYIEgGmLQHMf3yR1r5dkCYFNZ6ND0uWrp8V0NguqAvFy32PNEz5Mnz/qxnKBLLHHeVo3WSPx/rMNaNq6gnFJvZ5zbP7czEx0Ff2x6baItD41125FnSe/gbF/9rEk6yRZW4zVRe46rVGnGxO0zDzIiN3CWWw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com; spf=pass smtp.mailfrom=sk.com; arc=none smtp.client-ip=166.125.252.92
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=sk.com
X-AuditID: a67dfc5b-669ff7000002311f-5e-682af76ce22a
...
Subject: [PATCH v16 02/42] dept: implement DEPT(DEPendency Tracker)
Date: Mon, 19 May 2025 18:17:46 +0900
Message-Id: <20250519091826.19752-3-byungchul@sk.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20250519091826.19752-1-byungchul@sk.com>
References: <20250519091826.19752-1-byungchul@sk.com>
X-Brightmail-Tracker: 
X-Brightmail-Tracker: 
...
new file mode 100644
index 000000000000..a6671b13891f
--- /dev/null
...
index f9051ab610d5..54b03db59a12 100644
--- a/lib/Kconfig.debug
+++ b/lib/Kconfig.debug
