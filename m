...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B5EC84BB65A
	for <lists+linux-ide@lfdr.de>; Fri, 18 Feb 2022 11:06:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232459AbiBRKGh (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Fri, 18 Feb 2022 05:06:37 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:47790 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231401AbiBRKGg (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Fri, 18 Feb 2022 05:06:36 -0500
Received: from mxout03.lancloud.ru (mxout03.lancloud.ru [45.84.86.113])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4D94292D3A
        for <linux-ide@vger.kernel.org>; Fri, 18 Feb 2022 02:06:18 -0800 (PST)
Received: from LanCloud
DKIM-Filter: OpenDKIM Filter v2.11.0 mxout03.lancloud.ru B340420EE9CD
Received: from LanCloud
Received: from LanCloud
Received: from LanCloud
From:   Sergey Shtylyov <s.shtylyov@omp.ru>
Subject: [PATCH v2] ata: pata_hpt37x: merge transfer mode setting methods
To:     Damien Le Moal <damien.lemoal@opensource.wdc.com>,
        <linux-ide@vger.kernel.org>
Organization: Open Mobile Platform
Message-ID: <e3a09b84-1285-fd2c-689b-26c9c013dc0b@omp.ru>
Date:   Fri, 18 Feb 2022 13:06:14 +0300
...
- fixed up the 'kernel-doc' comments to hpt37x_set_{pio|dma}mode();
- somewhat reworded the subject.

 drivers/ata/pata_hpt37x.c |   75 +++++++---------------------------------------
...
@@ -442,29 +442,29 @@ static void hpt370_set_mode(struct ata_p
