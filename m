...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id AB38314B521
	for <lists+linux-ide@lfdr.de>; Tue, 28 Jan 2020 14:35:56 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726618AbgA1Nfj (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Tue, 28 Jan 2020 08:35:39 -0500
Received: from mailout2.w1.samsung.com ([210.118.77.12]:52350 "EHLO
        mailout2.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726438AbgA1NeP (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Tue, 28 Jan 2020 08:34:15 -0500
Received: from eucas1p1.samsung.com (unknown [182.198.249.206])
        by mailout2.w1.samsung.com (KnoxPortal) with ESMTP id 20200128133414euoutp0254383c78bd6e152ee54538a21a3e827e~uEE-UWQn02801628016euoutp02k
        for <linux-ide@vger.kernel.org>; Tue, 28 Jan 2020 13:34:14 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout2.w1.samsung.com 20200128133414euoutp0254383c78bd6e152ee54538a21a3e827e~uEE-UWQn02801628016euoutp02k
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1580218454;
        bh=DlGB2I0x8F3/bY9YdVcWyobgKzYHxlODIAoi6Gsf6vo=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=X69Y/Lp0yFs7E9h6HmRhhW8w5g6GIWleJx8j2YQlt3O0GxhT/tuJ9GpNuQEdJPJ8X
         8BI00zGiw4tGtbCRFBMB8q68RexgpDMbwuBL0u46ZaSJG+/z/XT/NQUBt7f2wwnxOb
         kmZPpodt/7q5oBNRo5SNl/+8NvNeyG8ggcATKwDM=
Received: from eusmges1new.samsung.com (unknown [203.254.199.242]) by
        eucas1p1.samsung.com (KnoxPortal) with ESMTP id
        20200128133413eucas1p1d269d47bd7fef4b023d6408d62e8b33d~uEE_7_FZD1586715867eucas1p1E;
        Tue, 28 Jan 2020 13:34:13 +0000 (GMT)
Received: from eucas1p2.samsung.com ( [182.198.249.207]) by
        eusmges1new.samsung.com (EUCPMTA) with SMTP id 0D.CA.61286.558303E5; Tue, 28
        Jan 2020 13:34:13 +0000 (GMT)
Received: from eusmtrp2.samsung.com (unknown [182.198.249.139]) by
        eucas1p1.samsung.com (KnoxPortal) with ESMTPA id
        20200128133413eucas1p195d291f69413cbb3bb86da9571942259~uEE_cXJvh1369913699eucas1p1P;
        Tue, 28 Jan 2020 13:34:13 +0000 (GMT)
Received: from eusmgms2.samsung.com (unknown [182.198.249.180]) by
        eusmtrp2.samsung.com (KnoxPortal) with ESMTP id
        20200128133413eusmtrp2d17653f8c0d35a9b0d11b26295ccc9c3~uEE_bsiy60330003300eusmtrp2u;
        Tue, 28 Jan 2020 13:34:13 +0000 (GMT)
X-AuditID: cbfec7f2-ef1ff7000001ef66-7a-5e3038559289
Received: from eusmtip2.samsung.com ( [203.254.199.222]) by
        eusmgms2.samsung.com (EUCPMTA) with SMTP id 6F.72.07950.558303E5; Tue, 28
        Jan 2020 13:34:13 +0000 (GMT)
Received: from AMDC3058.digital.local (unknown [106.120.51.71]) by
        eusmtip2.samsung.com (KnoxPortal) with ESMTPA id
        20200128133412eusmtip28cdcd4800c29541ab4959b163ed0d836~uEE_EuNZ00657106571eusmtip2e;
...
Subject: [PATCH 08/28] ata: move EXPORT_SYMBOL_GPL()s close to exported code
Date:   Tue, 28 Jan 2020 14:33:23 +0100
Message-Id: <20200128133343.29905-9-b.zolnierkie@samsung.com>
X-Mailer: git-send-email 2.24.1
In-Reply-To: <20200128133343.29905-1-b.zolnierkie@samsung.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Brightmail-Tracker: 
X-Brightmail-Tracker: 
X-CMS-MailID: 20200128133413eucas1p195d291f69413cbb3bb86da9571942259
X-Msg-Generator: CA
Content-Type: text/plain; charset="utf-8"
X-RootMTR: 20200128133413eucas1p195d291f69413cbb3bb86da9571942259
X-EPHeader: CA
CMS-TYPE: 201P
X-CMS-RootMailID: 20200128133413eucas1p195d291f69413cbb3bb86da9571942259
