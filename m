...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6A23247BAC4
	for <lists+linux-ide@lfdr.de>; Tue, 21 Dec 2021 08:22:47 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230430AbhLUHWq (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Tue, 21 Dec 2021 02:22:46 -0500
Received: from smtp-out2.suse.de ([195.135.220.29]:55820 "EHLO
        smtp-out2.suse.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231524AbhLUHWm (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Tue, 21 Dec 2021 02:22:42 -0500
Received: from relay2.suse.de (relay2.suse.de [149.44.160.134])
        by smtp-out2.suse.de (Postfix) with ESMTP id C28741F3B8;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        ...
        bh=SNu1e78t0Gle8Fz2BFJDwwQLhKcc7Xjc9EwBTtS0+LI=;
        b=VnyqLcMPBUJNpnD9wt6h4eSzIo/YJTAePlDKB8txm4FHja6grxPOZ6EFNu6XpDjs63Yb7F
        uuimFYFnQ0Fm3er9AFUyKaVTVgdryGmGcoKpa0rnuHqvKymZm2eW8KNz2j4Ddr8j8raSVy
        Xj7kYO4OKrUDy3Vhk7PQkP7tbbwL6E0=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        ...
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         ...
         in-reply-to:in-reply-to:references:references;
        bh=SNu1e78t0Gle8Fz2BFJDwwQLhKcc7Xjc9EwBTtS0+LI=;
        b=m+Xti8ngLW2dcH/+apX0YsAOudziYUAiNx+4jBxpgVYnuz8GtezJDPLgCQIcvn8wK1P0qR
        fDvD1woEj7+d+dBA==
Received: from adalid.arch.suse.de (adalid.arch.suse.de [10.161.8.13])
        by relay2.suse.de (Postfix) with ESMTP id BBBCFA3B8C;
        Tue, 21 Dec 2021 07:22:41 +0000 (UTC)
Received: by adalid.arch.suse.de (Postfix, from userid 16045)
        id B95445192382; Tue, 21 Dec 2021 08:22:41 +0100 (CET)
