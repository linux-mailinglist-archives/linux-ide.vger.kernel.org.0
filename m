Return-Path: <linux-ide+bounces-4177-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F492B34624
	for <lists+linux-ide@lfdr.de>; Mon, 25 Aug 2025 17:43:19 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id A3ABC7AE07F
	for <lists+linux-ide@lfdr.de>; Mon, 25 Aug 2025 15:41:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 157F92FF179;
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9B2282FD7A8
	for <linux-ide@vger.kernel.org>; Mon, 25 Aug 2025 15:42:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1756136564; cv=none; b=mZEk2TL3zLX1cTdCuL11gcVSDVXCIZgozwNOZub/oceGtSxfeTw1KZ9m3NLkHYORZurZ7lXlfhl0xivi9WTHFcrzF9iLM5cAanXF/8jOl12hLjM20XjhMgT2w4EpvQaZWBMxp6NJnD5FyjR1G28SVFRuZKWYISTvAoQFys/S7C8=
...
Received: from mail-wm1-f70.google.com (mail-wm1-f70.google.com
 ...
 us-mta-44-Y7onypiEMn6yAL88Jdajvg-1; Mon, 25 Aug 2025 11:42:39 -0400
X-MC-Unique: Y7onypiEMn6yAL88Jdajvg-1
X-Mimecast-MFC-AGG-ID: Y7onypiEMn6yAL88Jdajvg_1756136558
Received: by mail-wm1-f70.google.com with SMTP id 5b1f17b1804b1-45a1b0bd6a9so24574685e9.2
        for <linux-ide@vger.kernel.org>; Mon, 25 Aug 2025 08:42:38 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:autocrypt:content-language
         ...
         :reply-to;
        bh=5rvZAalDayw76mXlaVcK2G8fQoANSfCHvdaqQVOogfc=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCX2ZfWc6oUMbEKhhLqgoN0MwtFptaOyfuemiyY83Uuap3thd4ySx/fveqT5snjzjeztXNhHrqc5yIc=@vger.kernel.org
X-Gm-Message-State: AOJu0Yx3RBkzYD7FTM5WtevLo7eQ402Ml65427OxiYcc0xkZ/nGPnR48
	ITaRmS/X8JbmFTSYSgvO08f+/Vid/V2eKLC3VKSNo0qRpe2+cD1n8qdTBnClybdqCXA+gTwI5b1
	tl5chh15VbXjyzG+rR97SK4x5I6/tacyCqWQfTojLbVhk4bzH3PR7puYDEzioqw==
X-Gm-Gg: 
X-Received: by 2002:a05:600c:a344:b0:459:443e:b180 with SMTP id 5b1f17b1804b1-45b51f30f97mr116842365e9.8.1756136557849;
