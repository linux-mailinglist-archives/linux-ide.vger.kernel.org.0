Return-Path: <linux-ide+bounces-1951-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A2A9C93AC52
	for <lists+linux-ide@lfdr.de>; Wed, 24 Jul 2024 07:45:48 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 5ED1428523B
	for <lists+linux-ide@lfdr.de>; Wed, 24 Jul 2024 05:45:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 246A24595D;
	Wed, 24 Jul 2024 05:45:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="n63gDJc5"
X-Original-To: linux-ide@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id F2D135695
...
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1721799944; c=relaxed/simple;
	bh=1dOR5Q9JS9II/0GANAVkW3jImwTV/m59pSVPHn1o2Ek=;
	h=From:To:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=sHHnCdL1P9t13173nJHtSzX7kVnatFfMD2qD08iymykfb1Td1RrDySlO312nyUvtBXhdcdPPDDjhPNa/OxH63hyN4o1TW1mSenEnfm0eWPGoz5BFHvmvrI6VHYtY8D+pmn+D43XcuQcfxSs/L/mb2p77aQ9KCNQyjCIdxEDDbNo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=n63gDJc5; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 50A78C4AF10;
	Wed, 24 Jul 2024 05:45:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1721799943;
	bh=1dOR5Q9JS9II/0GANAVkW3jImwTV/m59pSVPHn1o2Ek=;
	h=From:To:Subject:Date:In-Reply-To:References:From;
	b=
From: Damien Le Moal <dlemoal@kernel.org>
To: linux-ide@vger.kernel.org,
	Niklas Cassel <cassel@kernel.org>
Subject: [PATCH v5 4/4] ata: libata: Print horkages applied to devices
Date: Wed, 24 Jul 2024 14:45:39 +0900
Message-ID: <20240724054539.182655-5-dlemoal@kernel.org>
