Return-Path: <linux-ide+bounces-3329-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id DF088A76F84
	for <lists+linux-ide@lfdr.de>; Mon, 31 Mar 2025 22:41:57 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 2F8BA3A9C23
	for <lists+linux-ide@lfdr.de>; Mon, 31 Mar 2025 20:41:43 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B6ABA21B918;
...
Received: from mail-wr1-f43.google.com (mail-wr1-f43.google.com [209.85.221.43])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 047C121ABDC
	for <linux-ide@vger.kernel.org>; Mon, 31 Mar 2025 20:41:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.221.43
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1743453708; cv=none; b=u3c/R68W+6V6ZMhUmeMUEJ7kqG/CObaco2NNy3fpWmx3S4PX76S3K8ECXjLDe7HCkPJD7Dvt+K3jaKCgG7RuaiTa64yd6n/VTlb7ycI4R/ImewVc8tPIJVaj5hzdWarmvwdNOMXzZRndWwZ108V5qpjz1NOSvFntqyB7F1Dc6NI=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=citrix.com; spf=pass smtp.mailfrom=cloud.com; dkim=pass (1024-bit key) header.d=citrix.com header.i=@citrix.com header.b=WafMnNSj; arc=none smtp.client-ip=209.85.221.43
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=citrix.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=cloud.com
Received: by mail-wr1-f43.google.com with SMTP id ffacd0b85a97d-39149bccb69so4317169f8f.2
        for <linux-ide@vger.kernel.org>; Mon, 31 Mar 2025 13:41:45 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:autocrypt:from
         ...
         :message-id:reply-to;
        bh=rGJAe0UQZxK4zMdJovc/1efMoUHDDD05RrKDXkqIC1k=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVxbyLSmY8FPBZGoclEPJ9jnQ76IbxOYcYQ5a2BqFDWv011Il/fJ4Hi8/0zuI4KjVRWKXRA1mjKkB8=@vger.kernel.org
X-Gm-Message-State: AOJu0YyV8vKLo3+qYT9cR7xyuD7oGIK/WHcnj+MVf9NjHn/DCO8Yj3j5
	7990AjDeHGwvn7YEA9fbX9WfeX/gzjddr4moVxnyOmNO4uNwdONDBJKhR6Bzy5k=
X-Gm-Gg: 
