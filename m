Return-Path: <linux-ide+bounces-4531-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A46DBC87D4
	for <lists+linux-ide@lfdr.de>; Thu, 09 Oct 2025 12:28:02 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 079E719E6790
	for <lists+linux-ide@lfdr.de>; Thu,  9 Oct 2025 10:28:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C04872DC332;
	Thu,  9 Oct 2025 10:27:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="eI3E/+4C"
X-Original-To: linux-ide@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C31FE2DF152
	for <linux-ide@vger.kernel.org>; Thu,  9 Oct 2025 10:27:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1760005652; cv=none; b=QazCamY5K7d/77CZJW5G9VOikk2UAPS/8dyX0Tkit0s6I6k4PsPpRU/+265OswBKOR/DPZc3Y61Vr2u9xGDj2Io7UKjo+aMbI1pyUdN7m83CVaKTCGVJ5ib/llG6z5mZk1X8XaOrkkrtMeqhxqr52l+I4+x7gkkm9jegWfngzkE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1760005652; c=relaxed/simple;
	bh=gjNchrIrptkCPpdvBCJAeaWget80k4em2qbd8f4Te2E=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=PSa7ubmJsOV7GwarH2vcfufqpKwZCFaLngKlW1F/81BEabrW6a+HqF1VQ8SYRKb0shB8PNY1aW2K8Hiui8xNCn5OiUNkhKWEsZchAk3urtI6kqhjs525BZJtZhOa291l1KYvS7czxmX2rCl+1E8Um1T/Z8w9hwFNwZOeOg+RXrs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=eI3E/+4C; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1760005650;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=PnaMSwBDtuymaXBhgXecb0+EmYLZhk15irlwltuvb1Y=;
	b=eI3E/+4C8RvCOXr2TfoXPxDjzsWXv9Ks65SYt5SWg197ZPA01mk1ThwG6S0LcITzHVFWcx
	PYzU5ARxr7yQ1TN3nfyKIjbdq+ymRPF9RrSCcazQyLj7Ef5d0KMpMGLVXzYUjJ4T0lGHtw
	cSAqbA8OX7e11W+lKvcyy+5o0/bwpGk=
Received: from mail-wm1-f69.google.com (mail-wm1-f69.google.com
 [209.85.128.69]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-307-jdq3bMAuNzaspTtytfKSEg-1; Thu, 09 Oct 2025 06:27:26 -0400
X-MC-Unique: jdq3bMAuNzaspTtytfKSEg-1
X-Mimecast-MFC-AGG-ID: jdq3bMAuNzaspTtytfKSEg_1760005644
Received: by mail-wm1-f69.google.com with SMTP id 5b1f17b1804b1-46e4335fa87so4564605e9.0
        for <linux-ide@vger.kernel.org>; Thu, 09 Oct 2025 03:27:24 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:autocrypt:content-language
         ...
         :reply-to;
        bh=PnaMSwBDtuymaXBhgXecb0+EmYLZhk15irlwltuvb1Y=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWKKH+I0Ztqb9ezLSpxPtiGbTN7NzYfoO5kwwmq9wAieQen21ioHGscmRZb+qHFHheh2poKG1Euzj0=@vger.kernel.org
X-Gm-Message-State: AOJu0YyFA+tAt6TCYgQSK/OftRB7f1dcvtqF2BG8+v4JmPI0OJpyuPBG
	J7JLgYW0YmVc1leAVS5Dh0TJLpQEcBGpEuhTx9snd0NGlf3JASATsTLUR3aMGgtf06ncDupJ+2+
	rG/oCxFVZGHdcbqE6XqFt/oz/PFzJvAprLkWzXAu1Umn6jedA4+Xm6oFkYSaDBw==
X-Gm-Gg: 
	XFUux/3ag
X-Received: by 2002:a05:6000:26c9:b0:425:74e1:25f7 with SMTP id ffacd0b85a97d-4266e8e6d0amr4383257f8f.62.1760005643622;
