...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 66E417A8402
	for <lists+linux-ide@lfdr.de>; Wed, 20 Sep 2023 15:55:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236455AbjITNzT (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Wed, 20 Sep 2023 09:55:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52278 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236486AbjITNzM (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Wed, 20 Sep 2023 09:55:12 -0400
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D3922110;
        Wed, 20 Sep 2023 06:54:51 -0700 (PDT)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id F2600C433C9;
        Wed, 20 Sep 2023 13:54:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1695218091;
        bh=Up5HuQ0oRE0unNXwT/+4XddJ36eN73Pe82LnB9KzbXE=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v4 05/23] ata: libata-scsi: Disable scsi device manage_system_start_stop
Date:   Wed, 20 Sep 2023 22:54:21 +0900
Message-ID: <20230920135439.929695-6-dlemoal@kernel.org>
...
index a7c3ec2b5970..6ce436992792 100644
...
-		sdev->no_start_on_resume = 1;
 	...
 	/*
@@ -1235,7 +1233,7 @@ static unsigned int ata_scsi_start_stop_xlat(struct ata_queued_cmd *qc)
 	}
...
+		tf->nsect = 1;  /* 1 sector, lba=0 */
 		...
 		if (qc->dev->flags & ATA_DFLAG_LBA) {
 			tf->flags |= ATA_TFLAG_LBA;
@@ -1251,7 +1249,7 @@ static unsigned int ata_scsi_start_stop_xlat(struct ata_queued_cmd *qc)
...
@@ -1261,7 +1259,7 @@ static unsigned int ata_scsi_start_stop_xlat(struct ata_queued_cmd *qc)
 			goto skip;
