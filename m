Return-Path: <linux-ide+bounces-820-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 86D428771E3
	for <lists+linux-ide@lfdr.de>; Sat,  9 Mar 2024 16:24:04 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id A75BAB20CAE
	for <lists+linux-ide@lfdr.de>; Sat,  9 Mar 2024 15:24:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CC7974436D;
...
Received: from mail-wm1-f43.google.com (mail-wm1-f43.google.com [209.85.128.43])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EDBA52C853
	for <linux-ide@vger.kernel.org>; Sat,  9 Mar 2024 15:23:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.43
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709997836; cv=none; b=LmbxxmHNxw0ISeVFLht5l1BOVDd/hD2l7XXZX52wjbmoNbaWtdj0jLEMLQnYz5UpQPFDYEjwkmjsi3L/TaF9Xw2zJHD910To3M95BX5eoABHFYS9O23ejwuRu7EdBkKIw2bEv2kIZXXCWl3pnNd7l/OGLBP71/ZgEOWvimsEuMw=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=FOEVaYlr; arc=none smtp.client-ip=209.85.128.43
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-wm1-f43.google.com with SMTP id 5b1f17b1804b1-412f0655d81so13337665e9.2
        for <linux-ide@vger.kernel.org>; Sat, 09 Mar 2024 07:23:54 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=z6g6e51lJa4UZ1+cxonkIuv5jTqNdN7CexyQ/0HADFs=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVL1KOGGhr8UOANcLudy/Fu+u/Kpxx8UoQbdjJuoHcMymW/IkREu2s0+t5LlU+SKdto+IRHl8OLSv3gUTR48t2Dvj5/ivMfOODF
X-Gm-Message-State: AOJu0YyPvB4+OEZZkimMO/wWq4kpvN6n5Xp89gJPiJGYuJjmptq+O4aV
	KU3qLmfrJ/lYZ/t3Y6ctu03UQZn0B236r2+KoExU3erbpz+qxbrUFQrUZXy7WcA=
