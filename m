...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0FEA65FF7AA
	for <lists+linux-ide@lfdr.de>; Sat, 15 Oct 2022 02:38:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229607AbiJOAiD (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Fri, 14 Oct 2022 20:38:03 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37916 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229577AbiJOAiD (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Fri, 14 Oct 2022 20:38:03 -0400
Received: from esa4.hgst.iphmx.com (esa4.hgst.iphmx.com [216.71.154.42])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 204023C166
        for <linux-ide@vger.kernel.org>; Fri, 14 Oct 2022 17:38:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=wdc.com; i=@wdc.com; q=dns/txt; s=dkim.wdc.com;
  t=1665794282; x=1697330282;
  h=message-id:date:mime-version:subject:to:cc:references:
   from:in-reply-to:content-transfer-encoding;
  bh=/QmhuhGpwxlsN1ypGljfDpvvTDeYqWgqdS1ywU2M30U=;
  b=dhajXloPp20q6GO6KO/lEQtjsGeKgtemnPUtm3wyz6bNMHJBUNY4OjqI
   lKP3UBXdgCBQIR/yKaOaV2i2daFu5ppA2PkikU8AyXboLOqYEQqTueHsm
   L4EVSGoGce9ZgpzP/reehRn3akZs2HPVA+HOjCiE6wDsj9mwKQJpwMWvi
   NW/F6agc26h5pyufv2Jj3UWOj9v1Pfnmq+Mm1dqmh+05bx/M38cOuIS/7
   U4V/fA7ZppQqOtpk+9ngUv81ytHq+BIWdYGV5Yg51IMh6nM79PdxDJG1U
   K5UQ755LWzvXnrdW0QuUmPjv6C7cdqiKN4/3pmQ8JFvtjsAX7Uparf8w1
   Q==;
X-IronPort-AV: E=Sophos;i="5.95,185,1661788800"; 
   d="scan'208";a="212179258"
Received: from h199-255-45-14.hgst.com (HELO uls-op-cesaep01.wdc.com) ([199.255.45.14])
  by ob1.hgst.iphmx.com with ESMTP; 15 Oct 2022 08:38:00 +0800
IronPort-SDR: 
 EKJwPaKydFmyCy9XkJnjEp0H
Received: from uls-op-cesaip02.wdc.com ([10.248.3.37])
  by uls-op-cesaep01.wdc.com with ESMTP/TLS/ECDHE-RSA-AES128-GCM-SHA256; 14 Oct 2022 16:57:35 -0700
IronPort-SDR: 
...
Received: from usg-ed-osssrv.wdc.com (usg-ed-osssrv.wdc.com [127.0.0.1])
        by usg-ed-osssrv.wdc.com (Postfix) with ESMTP id 4Mq49M5QNHz1RwqL
        for <linux-ide@vger.kernel.org>; Fri, 14 Oct 2022 17:37:59 -0700 (PDT)
...
Received: from usg-ed-osssrv.wdc.com ([127.0.0.1])
        ...
        with ESMTP id luN9vXamwUHb for <linux-ide@vger.kernel.org>;
