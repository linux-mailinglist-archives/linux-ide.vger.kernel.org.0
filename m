Return-Path: <linux-ide+bounces-1888-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 1FDC1931F56
	for <lists+linux-ide@lfdr.de>; Tue, 16 Jul 2024 05:37:22 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id CE14F282870
	for <lists+linux-ide@lfdr.de>; Tue, 16 Jul 2024 03:37:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AFCB01CF8B;
	Tue, 16 Jul 2024 03:36:54 +0000 (UTC)
X-Original-To: linux-ide@vger.kernel.org
Received: from inva020.nxp.com (inva020.nxp.com [92.121.34.13])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 59F79179AE;
	Tue, 16 Jul 2024 03:36:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=92.121.34.13
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1721101014; cv=none; b=ZyTqMUqLoi9bEg6zVBLi0iUZckB1ZR9jQKfoErSWX7sBiL2Orv69ytnIhbnLj4JpxlkY1dAGR0HWINplzglSYQ19wu+SNKyumPNu9f8mZdubRl/L+tUC3G+25N8b7jhadN42SYk+wATktE4kaUul3u31iiXi19+KoHQxELDM6XU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1721101014; c=relaxed/simple;
	bh=cJFqs0J7+rNyqEqWz5TssTFtDyTk4mOS4RwIWCxezJk=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References; b=dtNlT/djHE6dTCy+kYjNi54jkKeixC2hojZtWMl0j9+/uXKmJ+ABvVwVwwmIoSfsP8IQmjWpqx1TjNiG2GQ8sO5OKiHWKNp2yE23qVMUu+cXl82P84UL8NDolJUxOCPtSQTGSeCk11UzbhV/GVfACxdFSHRtK2+R2niS4hKPO94=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=nxp.com; spf=pass smtp.mailfrom=nxp.com; arc=none smtp.client-ip=92.121.34.13
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=nxp.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=nxp.com
Received: from inva020.nxp.com (localhost [127.0.0.1])
	by inva020.eu-rdc02.nxp.com (Postfix) with ESMTP id 9C1F51A0924;
	Tue, 16 Jul 2024 05:36:45 +0200 (CEST)
Received: from aprdc01srsp001v.ap-rdc01.nxp.com (aprdc01srsp001v.ap-rdc01.nxp.com [165.114.16.16])
	by inva020.eu-rdc02.nxp.com (Postfix) with ESMTP id 38E421A0914;
	Tue, 16 Jul 2024 05:36:45 +0200 (CEST)
Received: from localhost.localdomain (shlinux2.ap.freescale.net [10.192.224.44])
	by aprdc01srsp001v.ap-rdc01.nxp.com (Postfix) with ESMTP id 44DC7180226C;
	Tue, 16 Jul 2024 11:36:43 +0800 (+08)
...
Subject: [PATCH v3 2/4] ata: ahci_imx: Clean up code by using i.MX8Q HSIO PHY driver
Date: Tue, 16 Jul 2024 11:18:13 +0800
Message-Id: <1721099895-26098-3-git-send-email-hongxing.zhu@nxp.com>
