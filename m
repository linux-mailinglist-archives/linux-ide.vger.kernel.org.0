Return-Path: <linux-ide+bounces-4350-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 53D61B3E845
	for <lists+linux-ide@lfdr.de>; Mon,  1 Sep 2025 17:05:59 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 48A0D441B91
	for <lists+linux-ide@lfdr.de>; Mon,  1 Sep 2025 15:05:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9F092343D7C;
	Mon,  1 Sep 2025 15:05:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="dLRwZTnQ"
X-Original-To: linux-ide@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9FA05341673
	for <linux-ide@vger.kernel.org>; Mon,  1 Sep 2025 15:05:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1756739103; cv=none; b=gYcLR63ODL5E851d0uppwSq2uAEXW9Xr15yOmKjVwUFz7IbM7hxR3Lq8s0NLJIVidbsv3ULuB5syz3r0EFpNfA9nmo529xYqYIOvqdOSGqIe3h3JZE8Fox74g/+tV9gkoQmwPkFzQwWaNZpFl6PGtVOCk9M9aXIoCMdUvvkyVIQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1756739103; c=relaxed/simple;
	bh=rlptSlsXsKY9GjxBRSuhiJFXJD693wtRuhRLWV9EtSs=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=DL43eKSX8iw3dYfXZlQ1IxrXV/exFPoKfxwFSRJzs6sQOuqlj5GHFb0ACI6UoiGpmjqle9OAo4X6vD868C3Of8usgcRzFYI1x/9B5ox0DQ5VxttCyW2lKv4RRq5bSv0q2VbLs/6YXT1RcC8kjlvCDAEteecjq6u/iBt3IW7Ozg0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=dLRwZTnQ; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1756739100;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=OLi4fM0QNdibiBA1k/MTnIMFu1+uGtd+Ar5TgdqnEIc=;
	b=dLRwZTnQ45TzPEw7Gm/FrS7fr1YFGITByyu4vg0wBqycTrolaAd1+cLutmIFQOVHdP03iW
	j8WC8AZXSGqBdkL5Koh2hvqPQF5WlHGI8DjiuqXBSe8Ug7Rele+Rh8GMcg+bLRrPj7KlDW
	gGcXA9m22zIKeqnN91zTT14VMF/EykI=
