Return-Path: <linux-ide+bounces-4543-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id B5DBEBC92F9
	for <lists+linux-ide@lfdr.de>; Thu, 09 Oct 2025 15:05:29 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 2943E19E83B7
	for <lists+linux-ide@lfdr.de>; Thu,  9 Oct 2025 13:05:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8D2DD2E2F13;
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 824AC2E6CC4
	for <linux-ide@vger.kernel.org>; Thu,  9 Oct 2025 13:05:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1760015120; cv=none; b=QWMT6k+dPF3nGERC4jpU65rQfTKiakFlPIv2MB3tEnEwcoH/VaJoQ8cXeW3lqmJoQx5TLgc/NKYyfDNzhFoM/nZ3Oe9JSnWlNoT/1FdgIlyWRxxwH3pGuTYOl1/pZzooldnx5Lx4ZPjdathh/6BshrJacpvhnWcdhByPq/IeC/Y=
...
Received: from mail-wm1-f72.google.com (mail-wm1-f72.google.com
 ...
 us-mta-281-1VTt0C-gOZyNTDjHGYWeXg-1; Thu, 09 Oct 2025 09:05:14 -0400
X-MC-Unique: 1VTt0C-gOZyNTDjHGYWeXg-1
X-Mimecast-MFC-AGG-ID: 1VTt0C-gOZyNTDjHGYWeXg_1760015113
Received: by mail-wm1-f72.google.com with SMTP id 5b1f17b1804b1-46e46486972so6795545e9.0
        for <linux-ide@vger.kernel.org>; Thu, 09 Oct 2025 06:05:14 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:autocrypt:content-language
         ...
         :reply-to;
        bh=oTHo4iuJRNf/FsWLVapxfI0HO0lapgIr2CMWX1RNMGw=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVhNj6nJ9WZz42snzFapj+OjBQmJPGUu3+6giShwn+WN5q7jc+CftztGIHNVI+i9NWtP6d4b1HkmFs=@vger.kernel.org
X-Gm-Message-State: AOJu0YzCMadx/JWAWvpFq5f/CpOhNVkrYpbaq8WOZTFJQRzhE0qIeF+x
	4o53EZyHSQjkycsPdFMVbx+Eg3N9jLlEfSUpg8nsTTYSTvNJ0eC1lEYQBkymcY+TLjrpAONUqYr
	VPqg1TJ91lhA3UCf6pFCwuj0AAQoy3yHUka8xVXJ4CEpVqfyRqZDgEVdormlgUA==
X-Gm-Gg: 
	znHEW7QId
X-Received: by 2002:a05:600c:83c9:b0:46f:b42e:edd0 with SMTP id 5b1f17b1804b1-46fb42eee2emr2581065e9.41.1760015112976;
