Return-Path: <linux-ide+bounces-1134-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 91A9C897FF2
	for <lists+linux-ide@lfdr.de>; Thu,  4 Apr 2024 07:19:50 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 076DB1F24451
	for <lists+linux-ide@lfdr.de>; Thu,  4 Apr 2024 05:19:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 89A9E7442F;
	Thu,  4 Apr 2024 05:15:12 +0000 (UTC)
X-Original-To: linux-ide@vger.kernel.org
Received: from sakura.ysato.name (ik1-413-38519.vs.sakura.ne.jp [153.127.30.23])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 75B8A73526;
	Thu,  4 Apr 2024 05:15:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=153.127.30.23
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712207712; cv=none; b=HOpbXoS++kAetWRd+CX8XNCYSPsxE2ijvuVvGThBhwKLeOEVdL5uxHP+UCJpqBNZRWcJF/EZQPfkQS+Nmk0/Nkg6Ek0/2awsiAKd3Qt6NFxNTmdE26MCzF+hN/Dvh89OoylYLNVgyzPmuAPSTlQmidi1u4RMCQanFaNCcOF0DbQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712207712; c=relaxed/simple;
	bh=AS26eaglS7RJBQUnl7T6NslU0tdNz/37Vg4rHtcxbk4=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=mo/zNWJJnNly0L2X2rmW+wHZifBTd7pMdRPYKxE3I6vYlQQdEIZjfOgZg0wTvCG9Vj8VLBvS5nSVSmtu0+d/HcwrL6fbtV1Uh0/XoGZbB0/nj6pCiALvXAFRdQl0tblCoHTD+3rtiVrjJGL8Jbe4t3CvS+gb/IG2eimAYsz5Wo8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=users.sourceforge.jp; spf=fail smtp.mailfrom=users.sourceforge.jp; arc=none smtp.client-ip=153.127.30.23
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=users.sourceforge.jp
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=users.sourceforge.jp
Received: from SIOS1075.ysato.name (al128006.dynamic.ppp.asahi-net.or.jp [111.234.128.6])
	by sakura.ysato.name (Postfix) with ESMTPSA id BE6AD1C0FB1;
	Thu,  4 Apr 2024 14:15:07 +0900 (JST)
...
Date: Thu,  4 Apr 2024 14:14:19 +0900
Message-Id: <4a9b59733c7a8e7d042f3987ca6bf601eea5b30d.1712207606.git.ysato@users.sourceforge.jp>
