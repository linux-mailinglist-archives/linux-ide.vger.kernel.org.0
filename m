Return-Path: <linux-ide+bounces-4443-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F1C5BB2D31
	for <lists+linux-ide@lfdr.de>; Thu, 02 Oct 2025 10:15:05 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 0220F382BB9
	for <lists+linux-ide@lfdr.de>; Thu,  2 Oct 2025 08:14:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 22E412D3ECA;
	Thu,  2 Oct 2025 08:13:18 +0000 (UTC)
X-Original-To: linux-ide@vger.kernel.org
Received: from invmail4.hynix.com (exvmail4.skhynix.com [166.125.252.92])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 38B9E2D46B4;
	Thu,  2 Oct 2025 08:13:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=166.125.252.92
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1759392797; cv=none; b=dJ/piMTurZOeQ+8wWgaidY3cDN9omZo9VZTiC1N+7gW155bfVE0id2UVJoeMhK/LXxWTL3luSZm+iK/tyeHr4Mncg/DPgsyHIaQVtx6n1JCwcQrQ6yeHh/UFj5L09T9HTRydjaVpfYIBTnwWHqXfB/HaHvyxRfCzPdvgOULFFpw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1759392797; c=relaxed/simple;
	bh=nN9ExQbVAlsLCauWop4E923xisRO8jFDTiAnIrNIRU4=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References; b=FcwisRc+RzUwrgQl/7BRrHfU+66HDTJ4+D0Gn63Nm+SaczfLtzemi71r4xmrXUAhUfZ28JJOR946NhB88IwhkvP3fEPdVIL73rU+f4xKsyG0F2r+OacDaJBnF/jdYDSFnFxJbuaScpeWyGSOQcmv5trVFFFuSEM1VnXuKgPsnq8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com; spf=pass smtp.mailfrom=sk.com; arc=none smtp.client-ip=166.125.252.92
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=sk.com
X-AuditID: a67dfc5b-c45ff70000001609-61-68de340b3c05
...
X-Brightmail-Tracker: 
