Return-Path: <linux-ide+bounces-602-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E493385D470
	for <lists+linux-ide@lfdr.de>; Wed, 21 Feb 2024 10:51:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id DB4FD1C22F14
	for <lists+linux-ide@lfdr.de>; Wed, 21 Feb 2024 09:51:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 589B83F9EE;
	Wed, 21 Feb 2024 09:49:59 +0000 (UTC)
X-Original-To: linux-ide@vger.kernel.org
Received: from invmail4.hynix.com (exvmail4.skhynix.com [166.125.252.92])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7D8C53D3B7;
	Wed, 21 Feb 2024 09:49:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=166.125.252.92
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708508999; cv=none; b=svGG2NdhiVd+P6RB638evqoM9HfNA6EvDi1V0e4EAaDM7p3OmrtcHHIOFEaFHvM1DykawGvtIhxh9S9LEP/M7r4jPRqxYMihXVrlFikbbaTz0qoUZVcT/pBwaykxiPBqHlCl+A/TOf8M2m5+3gCgmDx0vAs8E/5O51uUh+0zGyk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708508999; c=relaxed/simple;
	bh=asSKRbIQNcB08UYPRwv3bUSMHrCIvUqTNtShomc8xTg=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References; b=a3mmUTTEBlabOfnJp3VbuXOoeuTVMc98bKcbDyqX7CzO1uf4UgCrZ6CvRNytcj7FOoqdKScjfL2q3/ubbPoflUwzQTEnk5wD5XJ37+ziVMlyFuk/Oax94ZufgU1Ou331l9il5ZgS1Qn6V5gay3llLRvoPTT7Ftg4yInTr4pGiaQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com; spf=pass smtp.mailfrom=sk.com; arc=none smtp.client-ip=166.125.252.92
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=sk.com
X-AuditID: a67dfc5b-d85ff70000001748-a6-65d5c738a185
...
Subject: [PATCH v12 02/27] dept: Implement Dept(Dependency Tracker)
Date: Wed, 21 Feb 2024 18:49:08 +0900
Message-Id: <20240221094933.36348-3-byungchul@sk.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20240221094933.36348-1-byungchul@sk.com>
References: <20240221094933.36348-1-byungchul@sk.com>
X-Brightmail-Tracker: 
X-Brightmail-Tracker: 
