Return-Path: <linux-ide+bounces-4147-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 41262B31AB0
	for <lists+linux-ide@lfdr.de>; Fri, 22 Aug 2025 16:05:59 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 542FB5A1827
	for <lists+linux-ide@lfdr.de>; Fri, 22 Aug 2025 14:02:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7B632311C12;
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C9D4A2FFDE1
	for <linux-ide@vger.kernel.org>; Fri, 22 Aug 2025 14:00:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1755871207; cv=none; b=m4ornyT9zaS2bO873IY0hnL2YmBQNgKXsCxUgqvTfqXGQj9Lq4SPrSUxVCgqbdrCAC2ehdwnwgqtNa/3QTlw5Wl+6gLSOVFMaY8fczUdYukQgGFwQsYhu5hxD5LH8ep5z/Z4+rKk7asysVSy5a6Ivk0uGNUrgWaS+mQR2JwWRqQ=
...
Received: from mail-wm1-f71.google.com (mail-wm1-f71.google.com
 ...
 us-mta-14-mlkECudTMTCMomkTCyzqzw-1; Fri, 22 Aug 2025 10:00:02 -0400
X-MC-Unique: mlkECudTMTCMomkTCyzqzw-1
X-Mimecast-MFC-AGG-ID: mlkECudTMTCMomkTCyzqzw_1755871201
Received: by mail-wm1-f71.google.com with SMTP id 5b1f17b1804b1-45b51411839so5394965e9.0
        for <linux-ide@vger.kernel.org>; Fri, 22 Aug 2025 07:00:01 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:autocrypt:content-language
         ...
         :reply-to;
        bh=K6aDoQ2nZkjhSfUgeR22UAGAXQBWHHuCN2RUasZyd3Q=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXP0fl1bI3SQX/VmwPc6z6BzJ/dn1v19xPpmXERbfChDPDXmvQxrrgZTbhTURAQRwQuJ0LHxw6nxVw=@vger.kernel.org
X-Gm-Message-State: AOJu0Yz0XO+dPr219CsCmZxEmM0y7iIL7VK7eRb01hVbVY8Rs8BREAzJ
	2HUwAm9z6kL+cMUO3+RqMh5Oo/vQ9dLPVoojI9mu1N2JnXhaN3bhXFJLggzf19vOcwdfbFWV/PE
	GxudFJKaJsl0vBumMUq2M35Q5saLbN8lcW0aw9VtrnQAiCrZ1aBQ4x4v6VbAMUw==
X-Gm-Gg: 
X-Received: by 2002:a05:600c:1554:b0:459:e06b:afb4 with SMTP id 5b1f17b1804b1-45b5179b4fcmr28181795e9.4.1755871200672;
