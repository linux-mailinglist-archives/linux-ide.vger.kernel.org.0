Return-Path: <linux-ide+bounces-4087-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 79A2FB3038C
	for <lists+linux-ide@lfdr.de>; Thu, 21 Aug 2025 22:08:09 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id B92FD7B7FB8
	for <lists+linux-ide@lfdr.de>; Thu, 21 Aug 2025 20:06:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3F1F534F46E;
	Thu, 21 Aug 2025 20:07:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="TyvButBN"
X-Original-To: linux-ide@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BAE322E9730
	for <linux-ide@vger.kernel.org>; Thu, 21 Aug 2025 20:07:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1755806836; cv=none; b=ToDzN2qMSL17qocaQClNcMg6V8537KOXDda/pvsHRxHQ3pYSbZordTMLGproNCYWvQD4tcCRLTO0oNSvj7WjhrTynMTf5asYfqo81h7PUpYjEX0hrE5IjGs5hX58Xu/xMi0I2Ujs3tV4Ib3QhT60MOomXu9P0rpS5lqdA+J0Dco=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1755806836; c=relaxed/simple;
	bh=1aX6aTG8s6ax1CtK3pZ1UQ/TXpBX5+Ze6lBjUUjUQPw=;
	h=From:To:Cc:Subject:Date:Message-ID:MIME-Version; b=AXUiLv3HIjPNc3OYhqMoHtXdfiwr08CbkQ4aNZcIAhSdroUWAM8A3IqQNVZ0at0246i5vfCLdCbKTLHLPT6Gi2SUeYDFEX0mxp8urVko0FwzvaOI4BzIHo6KQ/7DnL/WaKxeiqYx0tvB72rbsOqmsPofdOejmqhdPPh+RnXAj7Q=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=TyvButBN; arc=none smtp.client-ip=170.10.129.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=TyvButBNSzALOml1tau2KagepWSsZjQd3ZXyE9noQ995Hnsw9dCBh0PyvUrAf8loI+PI7g
	WYLGNAtozVq8iRC73goomianLwE1THMMAvdZFX45LdBmlC2lxDTb6ROKsjSnsaQVBUm2W/
	iJ92wi7olta3AcDgh/iN/aU5AUXKz/E=
Received: from mail-wm1-f71.google.com (mail-wm1-f71.google.com
 [209.85.128.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-439-NwOrfxJPPU6sgiFnGipmAA-1; Thu, 21 Aug 2025 16:07:07 -0400
X-MC-Unique: NwOrfxJPPU6sgiFnGipmAA-1
X-Mimecast-MFC-AGG-ID: NwOrfxJPPU6sgiFnGipmAA_1755806827
Received: by mail-wm1-f71.google.com with SMTP id 5b1f17b1804b1-45a1b0511b3so8300065e9.1
        for <linux-ide@vger.kernel.org>; Thu, 21 Aug 2025 13:07:07 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         ...
         :reply-to;
        bh=LLdMjSHtv+zm1bY5U2c0p8D/d+U3cemLYeHBKaj7voE=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWP270MMFlZSAyRK5AcVABTfA13xqMMdugAH36VVLfvTjpxKWHxALFVIIZZshupxvg73bLNuiZCXco=@vger.kernel.org
X-Gm-Message-State: AOJu0YwlGyeAHpLp3gP1fji5XMCJ6ep8ytv/ZXJdZOQ/ePLCnVUY+2Ql
	QCNLXZWE8yCEPSoPhdhvb2jp9oclAwPh64u51OKQMLvhQne/EsaHfhsGQS2s3TZXK9C4FXUoBr9
	stM9V4iRP414//GGo/IcnK2k0Wk/EJvp2ZUjbhuD2+3R61s3FQfk6Hgz2U2ge6Q==
X-Gm-Gg: 
X-Received: by 2002:a05:600c:4506:b0:456:1bae:5470 with SMTP id 5b1f17b1804b1-45b5179b6camr3191085e9.8.1755806826467;
