...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2C52758A7B6
	for <lists+linux-ide@lfdr.de>; Fri,  5 Aug 2022 10:05:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237612AbiHEIFa (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Fri, 5 Aug 2022 04:05:30 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33596 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240120AbiHEIF0 (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Fri, 5 Aug 2022 04:05:26 -0400
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 17B5712AC6;
        Fri,  5 Aug 2022 01:05:20 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1659686722; x=1691222722;
  h=date:from:to:cc:subject:message-id:
   content-transfer-encoding:mime-version;
  bh=n1yejLUw1B8CfbWFiL/gPGf548WeuUrggADTkxVaEr8=;
  b=NJNdIUeedRTQBfvokQR7rYCLr0uC0aewDR8qCysWz3V5Rnq/gERjbiJF
   5SzIF+QI1Pu/yQoNrFTfCvdyUbPAze5BjJ0c0fCWgGncH0IgvkQCzd5z/
   jy9LY82IrZv02ojWSIwE0hglFThz2y45Yx/Q6GpLfA5aPi/efTZXnMuaQ
   rIu6hsc/mP2LgjgDxGe23DWWIvHIO2uH0ttLwhh1GD5wckBn02H6+82Fs
   vaMgbril9EEsGFjzoAzlnhlsUrlfEYVCswHYGtrx9lagQe5cvD6wcWhAS
   H9AsN8yjRQm61GHVOA5V9pOJRcJho+OicPpffXOYL2frMQxtWBGi8ueOe
   g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10429"; a="273194641"
X-IronPort-AV: E=Sophos;i="5.93,216,1654585200"; 
   d="yaml'?scan'208";a="273194641"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Aug 2022 01:05:19 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,216,1654585200"; 
   d="yaml'?scan'208";a="579417270"
Received: from orsmsx603.amr.corp.intel.com ([10.22.229.16])
  by orsmga006.jf.intel.com with ESMTP; 05 Aug 2022 01:05:19 -0700
Received: from orsmsx605.amr.corp.intel.com (10.22.229.18) by
 ORSMSX603.amr.corp.intel.com (10.22.229.16) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2375.28; Fri, 5 Aug 2022 01:05:18 -0700
Received: from ORSEDG602.ED.cps.intel.com (10.7.248.7) by
 orsmsx605.amr.corp.intel.com (10.22.229.18) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2375.28 via Frontend Transport; Fri, 5 Aug 2022 01:05:18 -0700
Received: from NAM02-SN1-obe.outbound.protection.outlook.com (104.47.57.47) by
 edgegateway.intel.com (134.134.137.103) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2375.28; Fri, 5 Aug 2022 01:05:18 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=VNIUhr0r5m9UKGB7Gm4uXvpho/J785ebRUMGYdQHFKM=;
 b=
...
Received: from SJ1PR11MB6297.namprd11.prod.outlook.com
 ...
 ([fe80::35b8:ff0a:4f99:419c%6]) with mapi id 15.20.5458.024; Fri, 5 Aug 2022
 08:05:15 +0000
Date:   Fri, 5 Aug 2022 16:05:04 +0800
...
Subject: [ata]  0568e61225:  stress-ng.copy-file.ops_per_sec -15.0% regression
Message-ID: <YuzPMMnnY739Tnit@xsang-OptiPlex-9020>
Content-Type: multipart/mixed; boundary="E+F2dBrzA2iGJ8Mh"
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
User-Agent: Mutt/1.10.1 (2018-07-13)
X-ClientProxiedBy: SG2PR02CA0136.apcprd02.prod.outlook.com
 (2603:1096:4:188::16) To SJ1PR11MB6297.namprd11.prod.outlook.com
 (2603:10b6:a03:458::8)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-Correlation-Id: 4f7d6c3d-606b-43fe-af50-08da76b93a26
X-MS-TrafficTypeDiagnostic: MN2PR11MB3629:EE_
X-LD-Processed: 46c98d88-e344-4ed4-8496-4ed7712e255d,ExtAddr
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:SJ1PR11MB6297.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230016)(7916004)(39860400002)(136003)(346002)(366004)(396003)(376002)(44144004)(2906002)(41300700001)(6506007)(33716001)(6512007)(9686003)(86362001)(6666004)(26005)(38100700002)(82960400001)(83380400001)(186003)(8676002)(66476007)(235185007)(66946007)(66556008)(4326008)(21490400003)(5660300002)(54906003)(6916009)(316002)(8936002)(6486002)(966005)(478600001)(2700100001);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?iso-8859-1?Q?SHp0o0NGJAvMJ6GFXM+ncvd+qe8yAsewrWX+WMkJHMaaDzh7ufCunF8NYS?=
 =?iso-8859-1?Q?s0dNpTyaFed2Hv2fFlFxkmZ3dgKjcih/6Tvn3jgxt2rpJf+k+Lw/5pvr5g?=
 =?iso-8859-1?Q?dWMoDTkGDcBM+WQCS1ikx7xNDKqKTP+ekazrvPi4LU3tiDkVvmxYIKTxc6?=
 =?iso-8859-1?Q?gF+eKZe9jM6ZmeXedaTU3Nr2AJ455UFClkhx/ZiFyChItTCd7gZJ4Lc1Lg?=
 =?iso-8859-1?Q?Yu04BBIHkRtNE1sb4mRP+W9HpWH1FXUNG/mheBSVODQxEsVGVTOkZ6RS0Y?=
 =?iso-8859-1?Q?oHCL5hG5CllHTK/1FlijrfFo76fACWO6dXQR1m7OePKajq1rh/H60Fuh0J?=
 =?iso-8859-1?Q?YXBKn4p1kKn97Pe51i3HqFvf4b+iTb243K05oWv43FL859m7Q95qsNKF5y?=
 =?iso-8859-1?Q?76Aaggnd2rVczhL1ManYMuF0YTViljVJAB6n1BnwyLShtqFssxhapQLVaT?=
 =?iso-8859-1?Q?ZFkrZpv35r04JWsdnps2dcL5Ug16tlevaWpfWox89QJ90jJyRpTj5F4LES?=
 =?iso-8859-1?Q?mtrKZRAHZt/DPzQCk+b4RYCzoy0YrFLCr5ubAnrxM3K7IwaritnJXUkLHL?=
 =?iso-8859-1?Q?U90KvcMDiklgdxEEaq9HvOCyoDlJy61H6sEIYODFykRVjrvNB0l2KB2saI?=
 =?iso-8859-1?Q?B8GQvq9zREaZPNcpVMke9RaYP/bTDRYL5oUcwM4T1H3ipIW+r0K0J5Yi3V?=
 =?iso-8859-1?Q?C6ULDehQW2C37FGltpfQKJnY0x+D8okodEt86voSzz5at4kjIFSEe7gWv1?=
 =?iso-8859-1?Q?UPkfVLQ5cjQXgzIOdv5CTfbLqqmmS+1d3woMl2YE1DR8Id6StfDmzLXwzT?=
 =?iso-8859-1?Q?9YdRAMPTN89X+bpR/Eh9qcohmYVTm3e3GnrBJuJH/mBYgSfi8bYUQQ0Lr6?=
 =?iso-8859-1?Q?Fzm0jo4ErQpCf4pJe3aZQwK4VILtz7Ls06840+dYpLG7hXg/4ewaRoN0Hc?=
 =?iso-8859-1?Q?dsB4B51sZmv1XricCqKG3/E/r9qzySZqZdMW/HTkVJ+bPyAwBVq9rJPFFv?=
 =?iso-8859-1?Q?c1yxrX//9ZyIRjp9a1umLiRKI+8bwn8WzL5J6j+NjGaMaHHZ0b9kOeUPVM?=
 =?iso-8859-1?Q?xrzow2gJx+NxZ+M569Xm9CIrf7pWcIVjXDAh74IH7iaCJyu/HVZuki8118?=
 =?iso-8859-1?Q?UT+v5/ODdp9dTC6vrIeZ8VJHMYe2s0fhrw/kRANVcuXx/fUd+xMRwiCr2I?=
 =?iso-8859-1?Q?m9JYf3hi7BGyx3Qs+BWFj3JNoS9VeH2OSp9u9fERN6soLa0CrENRKtpY4v?=
 =?iso-8859-1?Q?J76CFBLEyBGpeGeWUzonFmrH485c44goia6FSxLFcTZTb1Bw1Cno0MJ+28?=
 =?iso-8859-1?Q?vbBagxKNXdb6Xggurv0Z3HqRtyBbmrEAtvHahdPMio39RRenPdHK8xPdt1?=
 =?iso-8859-1?Q?YW/WiMYyEoTqNQZ1JLmmw/zP0x9gXYu846DRnKvVItv+nZ0iBgq/wFaI8h?=
 =?iso-8859-1?Q?LSoiQSfSQBqZlenPK18ZCrAcSbljpwFwENstF1miUXaWYRJC+9wMgLNChh?=
 =?iso-8859-1?Q?zybkata0Zaudbo79oju0RuoJSMsck1imQqvr6WgaLYuIeNt5xea3PByjgk?=
 =?iso-8859-1?Q?a2hV/j+i9qxhEhJW5WLdfpW/Z8gIzqTVAAbMmJgZ6FvkQ6rJz9nUG4P1l7?=
 =?iso-8859-1?Q?/APCW+Fa5r0pmjfz5Mf7gkwg967JgrYqH7?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 4f7d6c3d-606b-43fe-af50-08da76b93a26
X-MS-Exchange-CrossTenant-AuthSource: SJ1PR11MB6297.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 05 Aug 2022 08:05:15.0798
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: wC5M84aiRqtFsmGlf3SAi/7ZvePSGqrqUe3gZ1vwe9Nq1MZnDzSKH15yQOyhT3B0wqwcplLLfilzHkCtIhh1NQ==
...
Content-Disposition: attachment;
	filename="config-5.19.0-rc3-00027-g0568e6122574"
...
submit_id: 62e7f58f5b08c89a58ad9fc2
job_file: "/lkp/jobs/scheduled/lkp-icl-2sp1/stress-ng-filesystem-performance-1HDD-f2fs-10%-copy-file-60s-ucode=0xb000280-debian-11.1-x86_64-20220510.cgz-0568e6122574dcc1ade-20220802-39512-vas7gy-0.yaml"
id: b7cd238fcb5d03aa7e9e7da1af301a6661f9d229
...
:#! include/fs/OTHERS:
kconfig: x86_64-rhel-8.3
enqueue_time: 2022-08-01 23:47:27.369308649 +08:00
_id: 62e7f58f5b08c89a58ad9fc2
_rt: "/result/stress-ng/filesystem-performance-1HDD-f2fs-10%-copy-file-60s-ucode=0xb000280/lkp-icl-2sp1/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-11/0568e6122574dcc1aded2979cd0245038efe22b6"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
head_commit: 77f360fd80f0e89df214c2231e2ffce4c54e0f60
base_commit: e0dccc3b76fb35bb257b4118367a883073d7390e
branch: hch-dma-mapping/for-next
rootfs: debian-11.1-x86_64-20220510.cgz
result_root: "/result/stress-ng/filesystem-performance-1HDD-f2fs-10%-copy-file-60s-ucode=0xb000280/lkp-icl-2sp1/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-11/0568e6122574dcc1aded2979cd0245038efe22b6/0"
scheduler_version: "/lkp/lkp/.src-20220728-201011"
arch: x86_64
max_uptime: 2100
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/0568e6122574dcc1aded2979cd0245038efe22b6/vmlinuz-5.19.0-rc3-00027-g0568e6122574
- branch=hch-dma-mapping/for-next
- job=/lkp/jobs/scheduled/lkp-icl-2sp1/stress-ng-filesystem-performance-1HDD-f2fs-10%-copy-file-60s-ucode=0xb000280-debian-11.1-x86_64-20220510.cgz-0568e6122574dcc1ade-20220802-39512-vas7gy-0.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=0568e6122574dcc1aded2979cd0245038efe22b6
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/0568e6122574dcc1aded2979cd0245038efe22b6/modules.cgz"
...
site: inn
:#! /cephfs/db/releases/20220729135123/lkp-src/include/site/inn:
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer:
watchdog:
:#! runtime status:
last_kernel: 5.19.0-rc3-00026-g4cbfca5f7750
repeat_to: 3
kbuild_queue_analysis: 1
schedule_notify_address:
:#! user overrides:
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/0568e6122574dcc1aded2979cd0245038efe22b6/vmlinuz-5.19.0-rc3-00027-g0568e6122574"
dequeue_time: 2022-08-02 01:27:40.465581428 +08:00
:#! /cephfs/db/releases/20220801181151/lkp-src/include/site/inn:
job_state: finished
loadavg: 6.39 2.11 0.75 1/888 8153
start_time: '1659374977'
end_time: '1659375039'
version: "/lkp/lkp/.src-20220728-201058:af335ace6:13a1a8cb9"
