Return-Path: <linux-ide+bounces-4223-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id C2C9AB38D87
	for <lists+linux-ide@lfdr.de>; Thu, 28 Aug 2025 00:15:38 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id AC6F1176993
	for <lists+linux-ide@lfdr.de>; Wed, 27 Aug 2025 22:15:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5AB4C3164AC;
	Wed, 27 Aug 2025 22:08:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="I2ZAc1S+"
X-Original-To: linux-ide@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9412D313524
	for <linux-ide@vger.kernel.org>; Wed, 27 Aug 2025 22:08:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1756332531; cv=none; b=YpbsznDMN7V/gzk9kxRwBIu6S3M4jhc057lTkoL6bZ/ScaDSI3uxqhD2T5cKnLPxNIfpZrwoTsjRlYT0mLi7be4IIk7nDv9TESDws7w0nqqzsmCmIoxs8FO8OqE4Lo6upZcA1vFqhPsYVT0OnOnFKdn+Dz7SLS8+5Kfss9LCWTo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1756332531; c=relaxed/simple;
	bh=YbWFu6hWV2YaR2aldi//FtcjtBFJJEpKJmLbibyDFL0=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=lHG+QEe9CIcwF/+VPnZWVfFzufdi6SdYc2ZDaRmOwCA0k0nUpqPZJuutGdVhmaa8xkqRy4tETn/iUPuP8IuyOuZqm9ho3KUn28ax+RUYdXaWxEVjqJJ6z0RepX/FRaNqVu0le4b7nThKJzsZtYih4qHUr/p8tKC+DM3oGtelLkA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=I2ZAc1S+; arc=none smtp.client-ip=170.10.129.124
