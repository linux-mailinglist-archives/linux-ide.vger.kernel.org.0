Return-Path: <linux-ide+bounces-1492-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id A7EFE8FBB8C
	for <lists+linux-ide@lfdr.de>; Tue,  4 Jun 2024 20:26:09 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 0A67E1F25CF8
	for <lists+linux-ide@lfdr.de>; Tue,  4 Jun 2024 18:26:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 24FEA14A60E;
	Tue,  4 Jun 2024 18:26:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="MysXdASZ"
X-Original-To: linux-ide@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2126914A4CC;
	Tue,  4 Jun 2024 18:25:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=192.198.163.19
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1717525559; cv=fail; b=AZL2T+LbxCx+WpB4EFCccpWrafn1Qjh/DfF+Cl3eqW9RXaqdX3AoDNdtZ0JydR69ssATx4lkAMBhUlbBpoSsCGJU2Lddt5l7JN6znCRxwKGZ3yHK8tc0JFsVnN24nRdiXnMsG0Sm+Nh+lnUq6Udv4GDWIJ4VebAml9vyAwtrB4o=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1717525559; c=relaxed/simple;
	bh=4ChRhiRj7RjIhJztJTVxnRCFyBKStQKVF+FdK5o0YeE=;
	h=Date:From:To:CC:Subject:Message-ID:References:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=Zzki2l4vDoVGcmyeLkF17UxfI30lHlcvJWBwCTJj6JwVOKZsl3daPfCUjTPivXQvXlQvK/TkyjRalj+AbnTowOuy64iBF3xlyEj/dZCNkxryjAFJ54rLqarSyLBiYvhM6LkiRj83/bpR0mNra/spwT6NP3vO3xy69RRl1QPSW8E=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=MysXdASZ; arc=fail smtp.client-ip=192.198.163.19
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1717525555; x=1749061555;
  h=date:from:to:cc:subject:message-id:references:
   in-reply-to:mime-version;
  bh=4ChRhiRj7RjIhJztJTVxnRCFyBKStQKVF+FdK5o0YeE=;
  b=MysXdASZxEKnbXUB1Mxz6J6bJD6AwSsUe5XTUaahX1Mmy6JZrW7eOP/g
   7Ab/cproa49Hi7/rIMA2MWuJ/5H3CxV9F6+78KSU+1ACypmJG527ExNGg
   Dly8WRpSMYecoPY+l62vtQK+gYmG3sW7afj1hTZyJiLXxDurInlYbi5av
   x1W52UM1g5lkWlSQ8tS1r6WHX0Yi6QON612APkKZiI7cyZntbNrFH8bqS
   8e1d81oaQIm/asQnNSHBmqmJReELFjGsuqwZWy9QoY03v0aFa49Ovngu9
   cMvaglKRH2Zn1Tp+dhABEho5M5aXXfkVz/DiREl9PYzmbk4xZQm5R5dl7
   A==;
X-CSE-ConnectionGUID: 7DsQIrbdRXCV9l1hdVUHfQ==
X-CSE-MsgGUID: LC5cIiCPSp+0hXpGDWBRuw==
X-IronPort-AV: E=McAfee;i="6600,9927,11093"; a="13902558"
X-IronPort-AV: E=Sophos;i="6.08,214,1712646000"; 
   d="scan'208";a="13902558"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
  by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Jun 2024 11:25:49 -0700
X-CSE-ConnectionGUID: xaieUJ/hTqSJUmCcslR5Cw==
X-CSE-MsgGUID: 9sPmAyWZTwe/w4yXYNG5PQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,214,1712646000"; 
   d="scan'208";a="37903847"
Received: from fmsmsx601.amr.corp.intel.com ([10.18.126.81])
  by orviesa008.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 04 Jun 2024 11:25:46 -0700
...
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MN0PR11MB6059.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(7416005)(366007)(1800799015)(376005);DIR:OUT;SFP:1101;
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 04 Jun 2024 18:25:40.0172
 (UTC)
