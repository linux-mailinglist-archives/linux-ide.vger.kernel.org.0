Return-Path: <linux-ide+bounces-764-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 3CACC8731AC
	for <lists+linux-ide@lfdr.de>; Wed,  6 Mar 2024 10:00:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 47D391F21270
	for <lists+linux-ide@lfdr.de>; Wed,  6 Mar 2024 09:00:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EFE3960ECF;
	Wed,  6 Mar 2024 08:55:41 +0000 (UTC)
X-Original-To: linux-ide@vger.kernel.org
Received: from invmail4.hynix.com (exvmail4.hynix.com [166.125.252.92])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0794D5DF19;
	Wed,  6 Mar 2024 08:55:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=166.125.252.92
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709715341; cv=none; b=shHzCjzn0PzkdhXR8kCs/Bv8FWxzW85AFkzwOTCwDZVG47pRvCCpcPzEJ8RUCbN8U73ITFR0avqXM+az/zjc3wiBAV4kj6mURH6VQGMC4IJV37YrAuIYw0/HVfRWCRSuMs8ZE4/u6b+3MiSGurRIEiCy6HfHLzDATnVvnURVaN0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709715341; c=relaxed/simple;
	bh=asSKRbIQNcB08UYPRwv3bUSMHrCIvUqTNtShomc8xTg=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References; b=IVOEvfX77Yn3apHmB8bfCQKTebsLcuZSFkR5pLb2ENS3C3m2zwkhF/EJ8ilu6tPMtTdV1ajIDVy3epPi1nt32N6LU512M2Vs9TYSqk+n5DGR8zDYK/M0D+tSoh2Y+4vBULJd1VPGUBwluo8AZg7wFZdX58TUlmPkpgte8gdmZ3Q=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com; spf=pass smtp.mailfrom=sk.com; arc=none smtp.client-ip=166.125.252.92
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=sk.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=sk.com
X-AuditID: a67dfc5b-d85ff70000001748-48-65e82f7c619a
...
Subject: [PATCH v13 02/27] dept: Implement Dept(Dependency Tracker)
Date: Wed,  6 Mar 2024 17:54:48 +0900
Message-Id: <20240306085513.41482-3-byungchul@sk.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20240306085513.41482-1-byungchul@sk.com>
References: <20240306085513.41482-1-byungchul@sk.com>
X-Brightmail-Tracker: 
	...
	+CvPQOZ2IuXG+ZsqY7Xf/5h+JeP19a4dr+DjhD/2PUQr5KovLf//U1xirF79lok+kFiTbbSj
	/ISCmP7uTRpi1mlj1jAms/YdI8+PmUkDAAA=
X-Brightmail-Tracker: 
