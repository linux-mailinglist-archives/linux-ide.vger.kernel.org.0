Return-Path: <linux-ide+bounces-2066-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A24794E4C0
	for <lists+linux-ide@lfdr.de>; Mon, 12 Aug 2024 04:22:10 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 3D90B1C213E4
	for <lists+linux-ide@lfdr.de>; Mon, 12 Aug 2024 02:22:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BBC3C13A895;
	Mon, 12 Aug 2024 02:21:26 +0000 (UTC)
X-Original-To: linux-ide@vger.kernel.org
Received: from inva020.nxp.com (inva020.nxp.com [92.121.34.13])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4670976410;
	Mon, 12 Aug 2024 02:21:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=92.121.34.13
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1723429286; cv=none; b=QQGNEJSM+AZ0fnRz4jesJDT1Ziy/BtUKbC6p0Yd+S66EEEwgMlohTxYoRnndF42WrL9fLgIELOO9qt+jl6Ctt0ocQYDIuPhStFiXbr8mLw4RiFqSH+shk5ul/Loh9ayLWdkaes/aguuDinnQfi27vDHxfngBr1mXppy9BZTSDXA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1723429286; c=relaxed/simple;
	bh=jf2Iix5rh+srHtUz4Euaz6QekMCGSdyW3g2w96HjaS4=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References; b=Dby13vTsxcOQJp6AMvBBhJKJK5hEkAQhn6KQel+Sx+7Wge07mKTTBLaTYmOi3y2klMqzV4JK9aJsnf2cKEqIQzRu6c6POV35k959i5qnWZlp3+SQfHJ38G1NPekR9MaZQeclaeTN2jg6WxB8Fz05P/8IwUqKNlkAZP6r0Kc9uoI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=nxp.com; spf=pass smtp.mailfrom=nxp.com; arc=none smtp.client-ip=92.121.34.13
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=nxp.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=nxp.com
Received: from inva020.nxp.com (localhost [127.0.0.1])
	by inva020.eu-rdc02.nxp.com (Postfix) with ESMTP id 1DBAD1A0FB1;
	Mon, 12 Aug 2024 04:21:16 +0200 (CEST)
Received: from aprdc01srsp001v.ap-rdc01.nxp.com (aprdc01srsp001v.ap-rdc01.nxp.com [165.114.16.16])
	by inva020.eu-rdc02.nxp.com (Postfix) with ESMTP id AE9F01A0FA6;
	Mon, 12 Aug 2024 04:21:15 +0200 (CEST)
Received: from localhost.localdomain (shlinux2.ap.freescale.net [10.192.224.44])
	by aprdc01srsp001v.ap-rdc01.nxp.com (Postfix) with ESMTP id 26C0E181D0FC;
	Mon, 12 Aug 2024 10:21:14 +0800 (+08)
...
Subject: [PATCH v6 2/5] ata: ahci_imx: Clean up code by using i.MX8Q HSIO PHY driver
Date: Mon, 12 Aug 2024 10:00:52 +0800
Message-Id: <1723428055-27021-3-git-send-email-hongxing.zhu@nxp.com>
