...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        ...
        b=WUVeyaPASpNywQfIBgNwb+6Lzyk+T7eZX++mC64IR0dYcipomLfgMAvttZUcSJMihDE0R8
        pyDXgqDkXlfoy+U/ujqjxfkJQ/NbKwTQ2W9UPyDGfDwEH3wafrwC0Evqo2ZCftuiyz3G6i
        jRN4ij83Y7VyRD8ITHccLEgZ3U2ogf0=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        ...
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         ...
         in-reply-to:in-reply-to:references:references;
        bh=P2a2ysqrXk3AxAx09K7JvbnJIbah2yT4J5iA1aIm8+w=;
        b=KHPewK0L4SVK+pz4UBlsuQsnvHMk6qwZWXIBdfwiXvHMr2K7GpUve51VAr8j3x0sAzKb3/
        U+e1Fe8j12BQwNCg==
Received: from adalid.arch.suse.de (adalid.arch.suse.de [10.161.8.13])
        by relay2.suse.de (Postfix) with ESMTP id 2F9C1A3BC9;
        Fri, 10 Dec 2021 07:29:19 +0000 (UTC)
Received: by adalid.arch.suse.de (Postfix, from userid 16045)
        id 2CA97519208B; Fri, 10 Dec 2021 08:29:19 +0100 (CET)
From:   Hannes Reinecke <hare@suse.de>
To:     Damien LeMoal <damien.lemoal@wdc.com>
Cc:     linux-ide@vger.kernel.org, Hannes Reinecke <hare@suse.de>
Subject: [PATCH 53/68] pata_it821x: convert printk() calls
Date:   Fri, 10 Dec 2021 08:28:50 +0100
Message-Id: <20211210072905.15666-54-hare@suse.de>
