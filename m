Return-Path: <linux-ide+bounces-4789-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 7FFAACBD218
	for <lists+linux-ide@lfdr.de>; Mon, 15 Dec 2025 10:18:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id BF0B53040673
	for <lists+linux-ide@lfdr.de>; Mon, 15 Dec 2025 09:15:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E41AA227EA7;
	Mon, 15 Dec 2025 09:06:36 +0000 (UTC)
...
Received: from mail-pl1-f169.google.com (mail-pl1-f169.google.com [209.85.214.169])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 813CA329C52
	for <linux-ide@vger.kernel.org>; Mon, 15 Dec 2025 09:06:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.169
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1765789596; cv=none; b=qpkKCA6NWe3RSUWlV3YSISzH+rOGbu8GtnRmz8GVPFG7fuJdupaZuY19HgmSXgEYOq+OnfS9WvmndNwI0g8B8KF24O8tqka632FI41Oy3fcNphwlO6wHggaCApm+A/Ndad69XfPCQcGLi1gtVrPS7Aa3KnGE+avJ7Y18Aqku84o=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1765789596; c=relaxed/simple;
	bh=S+I//71CAh3HG/ntXLeYl26reZdigPregIquYcMsXSQ=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=l5pDjN+JBLmjH63sd5uTTHzD8J3zHmTPhZhwdvdYHzDS0/ktvNI3FZXRP4/3iDxwesoSTJfbV3T7VQ+9CrtBdgahq/2mwoaw1NM8E/rLorQK8H2q2PbqovrjE5Euym1LOCV30ze39U9ocCEo5FxgMbxXOenwEjYenKSH0TAmkaU=
...
Received: by mail-pl1-f169.google.com with SMTP id d9443c01a7336-2a0d0788adaso8271925ad.3
        for <linux-ide@vger.kernel.org>; Mon, 15 Dec 2025 01:06:34 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=8TFzbFLNA/s8ANuMZPs94U2cOEd+GIJ7ZeP4XFmQHWk=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUSLA2wkO4c76iaUZasyi/RmV/bNLpASdD2XzOqh6lNxonYp90s3uYWzO7IjJ1S4bPB3CkAIJUzW30=@vger.kernel.org
X-Gm-Message-State: AOJu0YzgyjxIPBKVsSoJhqBJ46TzjzOE+nbEtNmwq9H+TEHb/uRG9E7u
	zUsJTZVEyN7fl1aYkig1YX8e4579/dfIxgAy3s202Bp9PhwSNZ52tD6K
X-Gm-Gg: 
