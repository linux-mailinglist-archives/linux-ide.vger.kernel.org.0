...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8B0A522C40A
	for <lists+linux-ide@lfdr.de>; Fri, 24 Jul 2020 13:08:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726329AbgGXLI0 (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Fri, 24 Jul 2020 07:08:26 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43816 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726114AbgGXLIZ (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Fri, 24 Jul 2020 07:08:25 -0400
Received: from mail-pf1-x442.google.com (mail-pf1-x442.google.com [IPv6:2607:f8b0:4864:20::442])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ABA5BC0619D3;
        Fri, 24 Jul 2020 04:08:25 -0700 (PDT)
Received: by mail-pf1-x442.google.com with SMTP id j20so4913213pfe.5;
        Fri, 24 Jul 2020 04:08:25 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=hVulgHYBDVuPa4ajDa6H+2qYUhIV1fdwgCQpPhvLN7o=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=hVulgHYBDVuPa4ajDa6H+2qYUhIV1fdwgCQpPhvLN7o=;
        b=
X-Gm-Message-State: AOAM531EIjwDFiZ03hkTUq72EuVOUSEflrgWywPSBim/N9U5iekpkvJP
        swNqm6RhvM3LHc/8v+iIkeQ=
X-Google-Smtp-Source: ABdhPJyuVmaWeiOCjDkHvCFXnYGMZ7IOCgjnGuIvkOu9sJOKoWWjOfgOoAfrccemujJ2ELbD8/fVNg==
X-Received: by 2002:a63:225d:: with SMTP id t29mr1766914pgm.374.1595588904534;
        Fri, 24 Jul 2020 04:08:24 -0700 (PDT)
Received: from varodek.iballbatonwifi.com ([103.105.153.67])
        by smtp.gmail.com with ESMTPSA id r70sm6201599pfc.109.2020.07.24.04.08.20
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 24 Jul 2020 04:08:23 -0700 (PDT)
...
Subject: [PATCH v1] ata: use generic power management
Date:   Fri, 24 Jul 2020 16:36:30 +0530
Message-Id: <20200724110630.1219882-1-vaibhavgupta40@gmail.com>
...
index 2a4d38b98026..a27f6f8c9b08 100644
--- a/drivers/ata/pata_triflex.c
+++ b/drivers/ata/pata_triflex.c
@@ -176,6 +176,13 @@ static struct ata_port_operations triflex_port_ops = {
