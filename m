Return-Path: <linux-ide+bounces-4329-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id CC4B9B3BCA2
	for <lists+linux-ide@lfdr.de>; Fri, 29 Aug 2025 15:42:01 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 86AF93BCC6D
	for <lists+linux-ide@lfdr.de>; Fri, 29 Aug 2025 13:41:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1540331CA67;
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 651AE31B130
	for <linux-ide@vger.kernel.org>; Fri, 29 Aug 2025 13:41:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1756474910; cv=none; b=j/y317jX2MsMBqbYkVFol8qBqUvtL3+P9ksn4JMlFiT4B/PGEu2V8EJizoBWw/Dl58XMgYKBg+sVtdrUiRnUVy5KaK2BXEPv5DsOYgZtsGbk1GRypMQ6UKvCTB6Z3WQ6lnXGLWHxlr0KmqhuNQJjE879pZDwACkCf2F9WVCv5O4=
...
Received: from mail-wm1-f69.google.com (mail-wm1-f69.google.com
 ...
 us-mta-656-o18e6WDvNhWS53g3WCeX3g-1; Fri, 29 Aug 2025 09:41:45 -0400
X-MC-Unique: o18e6WDvNhWS53g3WCeX3g-1
X-Mimecast-MFC-AGG-ID: o18e6WDvNhWS53g3WCeX3g_1756474904
Received: by mail-wm1-f69.google.com with SMTP id 5b1f17b1804b1-45a1ad21752so12836585e9.1
        for <linux-ide@vger.kernel.org>; Fri, 29 Aug 2025 06:41:44 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:autocrypt:content-language
         ...
         :reply-to;
        bh=7ZezTDYPV9FY1vYbYIlP1Z79qo+TmLw98Vo74TFiYNA=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVZw/yRUJ6V/fjAE7Lau5whCIgCj/74h1Zq/FqbtHARRRXeLeOw7PW992z4bFaRcT6+YqAWWDbzLCU=@vger.kernel.org
X-Gm-Message-State: AOJu0YxlCe0tRkPOQJvy0g7Hciqk4jdMGyO8uZZO8szE5/QezNC9LOO/
	mxBKzcZNZ6qWNe/Wcpqf6qqMpAGaVrm4xsf8rn5+4lRxCyhNDj2NgF0UlvtjYP6PXx+P4uGpFB7
	Sw0StuEU7j6P18ZVVEEqxoNdG4hR7nLQW7ec/zIis7J+JwfBQP/NlsScKTm6gqQ==
X-Gm-Gg: 
X-Received: by 2002:a05:600c:8b0a:b0:45b:733b:1feb with SMTP id 5b1f17b1804b1-45b733b214dmr83370675e9.10.1756474903640;
