...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7BA3779A423
	for <lists+linux-ide@lfdr.de>; Mon, 11 Sep 2023 09:07:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234595AbjIKHHN (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Mon, 11 Sep 2023 03:07:13 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33274 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234628AbjIKHHK (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Mon, 11 Sep 2023 03:07:10 -0400
Received: from smtp-out1.suse.de (smtp-out1.suse.de [IPv6:2001:67c:2178:6::1c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5EC2D19A;
        Mon, 11 Sep 2023 00:07:05 -0700 (PDT)
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by smtp-out1.suse.de (Postfix) with ESMTPS id 139FC2185A;
        Mon, 11 Sep 2023 07:07:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        t=1694416024; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=JW3+imdCvQ9Zd2SCKV9k+QpqwRelfjuT0U0bEdVdLAo=;
        b=HgUxYkorYD4j5W0Xp4Pmr5Z3G51MF8CzI0iRgT7pgDc8Zjqmkn3aOn8wZmgvyGvnMcXMxO
        8zB49fYoqGP9TT3w3yvfAIATq3ET0rawHHE+A4tQQaTsJPNo/PwqLJMI3VXrcopTi+FlWE
        DSFqH0IFSR+1f/vnYM5XXaGniRAy5a4=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        s=susede2_ed25519; t=1694416024;
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=JW3+imdCvQ9Zd2SCKV9k+QpqwRelfjuT0U0bEdVdLAo=;
        b=HmdUmhZRJm0ubcygmO2l3VpceKCj2xlAUs5YUuds8MZpuC0dyzylwaGilD6T1HQEIvVtMo
        VPkhvLuHKMHg+HAA==
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by imap2.suse-dmz.suse.de (Postfix) with ESMTPS id BDC6913780;
        Mon, 11 Sep 2023 07:07:03 +0000 (UTC)
Received: from dovecot-director2.suse.de ([192.168.254.65])
        by imap2.suse-dmz.suse.de with ESMTPSA
        id OBe8K5e8/mQKVwAAMHmgww
        (envelope-from <hare@suse.de>); Mon, 11 Sep 2023 07:07:03 +0000
Message-ID: <dbeac59b-e41d-40f4-beb1-8685efccedda@suse.de>
Date:   Mon, 11 Sep 2023 09:07:03 +0200
MIME-Version: 1.0
