Return-Path: <linux-ide+bounces-4537-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id D341ABC8C89
	for <lists+linux-ide@lfdr.de>; Thu, 09 Oct 2025 13:26:51 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 53D813A54C9
	for <lists+linux-ide@lfdr.de>; Thu,  9 Oct 2025 11:25:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C24232E1F0A;
...
Received: from mout02.posteo.de (mout02.posteo.de [185.67.36.66])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 918032DFF19
	for <linux-ide@vger.kernel.org>; Thu,  9 Oct 2025 11:24:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=185.67.36.66
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1760009094; cv=none; b=I/xtxe1pR+rIgZa2yv4whXfeSkquJfCg+fuFUGEFfGyx94QP0k9p5RJYJ9eHh88bieGDmUuiFLocYsrHpzIRCHZ/vMhiOV8TgPPi94Wsjgyw6XBiBwS5g0Ey4nkRYlai8N0naAEDSHcn5pFrXw8I4Yf61MCW8+Fr54CxFlENSz0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1760009094; c=relaxed/simple;
	bh=eYbQbzyGivSgRREnlDknbg8hmJ7/go8C4i/oaX1K9Bo=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=W+0bXVOIP9MT4Ty/nBxRKyuAkCAcSC58isDJCJJ3YjYCalmGGguLPxnHNRCbExDNdP3mDqGBMati696xgYLSFpaQQkqUWUZGpoF2Ns9PiwzelN3KoA3jzh/z2KdBpsKLeidh9veogR7jsnKH/4ZIJwaYE6CNvUZq0mA9i5in+50=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=posteo.de; spf=pass smtp.mailfrom=posteo.de; dkim=pass (2048-bit key) header.d=posteo.de header.i=@posteo.de header.b=BXt1/T/h; arc=none smtp.client-ip=185.67.36.66
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=posteo.de
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=posteo.de
Received: from submission (posteo.de [185.67.36.169]) 
	by mout02.posteo.de (Postfix) with ESMTPS id 018FD240101
	for <linux-ide@vger.kernel.org>; Thu,  9 Oct 2025 13:24:50 +0200 (CEST)
