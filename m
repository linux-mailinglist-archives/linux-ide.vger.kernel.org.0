Return-Path: <linux-ide+bounces-1488-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 219A88FAD9B
	for <lists+linux-ide@lfdr.de>; Tue,  4 Jun 2024 10:29:17 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 371591C22265
	for <lists+linux-ide@lfdr.de>; Tue,  4 Jun 2024 08:29:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9FCDB142E73;
	Tue,  4 Jun 2024 08:29:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="gex4Rvqu"
X-Original-To: linux-ide@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 72E4D14265A
	for <linux-ide@vger.kernel.org>; Tue,  4 Jun 2024 08:28:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1717489740; cv=none; b=dh40ywQ4H5HOjr7Tlga2a7vmrGpToAfrbJ+SshohNqtdC6hRS+LFlBVAoeFx7Zm/IcSsuf6RXbD14rLF012B6S+1z58TzIjEzG/X1GnbkhJeqbntny9Nr2ECb3jq6aGUlP6Xqkspse/QbyCWBw0cwghFRI+KfVdowO6BTiR4yGA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1717489740; c=relaxed/simple;
	bh=rzHBFBjrOD1LpzwYSLdt1evD+GdcoxpcN2M/rIgqwjM=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=C0T5jyH26ddYpDVA948mLSSnF+aEBAQ0jc8MO5MILna6s1kcspHUBpbHgU178fApG3WL9yvKJOzJsfZPReHs1jxJpN3H75aim9IL68XZaIh/58HHt9vAFupQxGbJMt8lp0xySXgKzASwJpvIZbKW5i25uyIEUM/Ibgd4UzwY9dU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=gex4Rvqu; arc=none smtp.client-ip=170.10.129.124
...
Received: from mail-ej1-f70.google.com (mail-ej1-f70.google.com
 ...
 us-mta-59-WQXV5osdMO6lNy_H_q3w5A-1; Tue, 04 Jun 2024 04:28:50 -0400
X-MC-Unique: WQXV5osdMO6lNy_H_q3w5A-1
Received: by mail-ej1-f70.google.com with SMTP id a640c23a62f3a-a68b2e99c38so163939766b.0
        for <linux-ide@vger.kernel.org>; Tue, 04 Jun 2024 01:28:49 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=uRxb4s91be8Z5K0PlcwW7xp4HZ8oD+zUX1ejruZ7C98=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVNi0erZVtntLaZLJ+x9DOFBfBxxHROVFgA4rN8Yvium+EW0Gfez30G9JGuIxirQnQkgmFFlAc5ton9XxuaLUrlxcb8lOEjL7AK
X-Gm-Message-State: AOJu0Yw/dIhmNHtLHMCYrhyFQIGR1nAwPLVdOb1krHc/xBrxfws24P67
	hbGujipdmd+zftOL6g6bQKLJzWytTfsTKJ1Wd7tBaHbmZ5yaq83N4V8rQGReWjMepL/pLE9+yo7
	12jFubNHTugwbpqsPdgreOwF9zErRp/CkRdiWai9+qhmDLaUGDyFFFjgenQ==
X-Received: by 2002:a17:906:a2d7:b0:a68:ecd5:6083 with SMTP id a640c23a62f3a-a68ece4a3a7mr568563466b.27.1717489726812;
...
X-Received: by 2002:a17:906:a2d7:b0:a68:ecd5:6083 with SMTP id a640c23a62f3a-a68ece4a3a7mr568554866b.27.1717489725588;
        Tue, 04 Jun 2024 01:28:45 -0700 (PDT)
Received: from ?IPV6:2001:1c00:c32:7800:5bfa:a036:83f0:f9ec? (2001-1c00-0c32-7800-5bfa-a036-83f0-f9ec.cable.dynamic.v6.ziggo.nl. [2001:1c00:c32:7800:5bfa:a036:83f0:f9ec])
        by smtp.gmail.com with ESMTPSA id a640c23a62f3a-a6900d7f6a3sm304055866b.90.2024.06.04.01.28.43
