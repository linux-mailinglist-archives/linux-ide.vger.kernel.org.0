...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 413E12020A4
	for <lists+linux-ide@lfdr.de>; Sat, 20 Jun 2020 05:32:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387446AbgFTDbw (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Fri, 19 Jun 2020 23:31:52 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58254 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1733246AbgFTDbV (ORCPT
        <rfc822;linux-ide@vger.kernel.org>); Fri, 19 Jun 2020 23:31:21 -0400
Received: from mail-pl1-x644.google.com (mail-pl1-x644.google.com [IPv6:2607:f8b0:4864:20::644])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D67AFC0698C3
        for <linux-ide@vger.kernel.org>; Fri, 19 Jun 2020 20:30:31 -0700 (PDT)
Received: by mail-pl1-x644.google.com with SMTP id d10so2913128pls.5
        for <linux-ide@vger.kernel.org>; Fri, 19 Jun 2020 20:30:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=sGLoZ/8MV5yI/hHBChws5+ru78fGtX7ZblvtsMciIaY=;
        b=OCwjpyOUoB1F/JcRqLIno1r4SeUwOd5fcsDpVKUa+hWsIJys1/v0j1vOICIl43PV77
         QMRg7Kjte+WYKVOOJvDQ9h6n5gSbhWUwxcYni18UXkVPNKuU9f7uX4dIrys7kMSn7Ncf
         +zTd1LuKUW9xEO2uMUXj+lBgg3955LS9xxnYs=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=sGLoZ/8MV5yI/hHBChws5+ru78fGtX7ZblvtsMciIaY=;
        b=
X-Gm-Message-State: AOAM531M4H8QBNEyGUut5+Jcz6cm+idLOyadpYtsnZkTIHduj+z+W5iZ
        6l6RtayrH1W4jwqxTiyFT84rIw==
X-Google-Smtp-Source: ABdhPJzN8ff3kNNc3j8l2TbMJf5ySYIWciFjsgb9Kt1VzBrbTX2JNEtx3BIMmItKmPF+ANSVObFyWA==
X-Received: by 2002:a17:90a:2c06:: with SMTP id m6mr6809325pjd.216.1592623830241;
        Fri, 19 Jun 2020 20:30:30 -0700 (PDT)
Received: from www.outflux.net (smtp.outflux.net. [198.145.64.163])
        by smtp.gmail.com with ESMTPSA id g29sm7044681pfr.47.2020.06.19.20.30.21
...
Subject: [PATCH v2 15/16] treewide: Remove uninitialized_var() usage
Date:   Fri, 19 Jun 2020 20:30:05 -0700
Message-Id: <20200620033007.1444705-15-keescook@chromium.org>
