Return-Path: <linux-ide+bounces-4220-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id B39E1B38D62
	for <lists+linux-ide@lfdr.de>; Thu, 28 Aug 2025 00:14:03 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 086011BA145C
	for <lists+linux-ide@lfdr.de>; Wed, 27 Aug 2025 22:13:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 684FA310762;
	Wed, 27 Aug 2025 22:08:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="V64n8EEK"
X-Original-To: linux-ide@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DC67630F943
	for <linux-ide@vger.kernel.org>; Wed, 27 Aug 2025 22:07:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1756332483; cv=none; b=sbN1cSRYzldV1BNAVLv7KDCQrKBZmyAhbffr9qp29kYkC0s+gQUBEZIeudTQyPIPhVRtrpXJ+ehvvM+OCVl6DSljvb0QwUHif7hXAePGgzp3ScHILbW0/p7Tnf+M6PgnrMaqNc88UOJgSow5Eh5sPG8rRnEf5gbLclb3qnJvbro=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1756332483; c=relaxed/simple;
	bh=bLHjOTNpsHVzUO+cO2M/nuJz28LIvshjEUcpE8PfecA=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=qgWhCxRD0nui0PE+n+UizQrYJ3B1PbJmG7b/eum5pvU3gvq5kU0n/N/MAvOmTw+G44BRsMQ1+iR6bCWb1SSTu7NNTM+dmLvriKG8S8/SH03NLF4bnWKvitvr9de11GFHJ/JdCLXQ++zvR2Hoh06VoexU+11GWQgCJatsCCQFrPM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=V64n8EEK; arc=none smtp.client-ip=170.10.129.124
