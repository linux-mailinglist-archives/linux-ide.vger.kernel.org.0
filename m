...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id E47AD45571
	for <lists+linux-ide@lfdr.de>; Fri, 14 Jun 2019 09:11:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726353AbfFNHLo (ORCPT <rfc822;lists+linux-ide@lfdr.de>);
        Fri, 14 Jun 2019 03:11:44 -0400
Received: from mx2.suse.de ([195.135.220.15]:58014 "EHLO mx1.suse.de"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1726108AbfFNHLn (ORCPT <rfc822;linux-ide@vger.kernel.org>);
        Fri, 14 Jun 2019 03:11:43 -0400
X-Virus-Scanned: by amavisd-new at test-mx.suse.de
Received: from relay2.suse.de (unknown [195.135.220.254])
        by mx1.suse.de (Postfix) with ESMTP id D89D4B017;
        Fri, 14 Jun 2019 07:11:41 +0000 (UTC)
From:   Jiri Slaby <jslaby@suse.cz>
To:     axboe@kernel.dk
Cc:     linux-kernel@vger.kernel.org, Jiri Slaby <jslaby@suse.cz>,
        linux-ide@vger.kernel.org
Subject: [RFC 2/3] ata: make qc_prep return an int
Date:   Fri, 14 Jun 2019 09:11:39 +0200
Message-Id: <20190614071140.6233-2-jslaby@suse.cz>
...
index b1b49dbd0b14..af768298969a 100644
...
index 0984c4b76d7e..9b6c4c9a2af7 100644
...
index aaa57e0c809d..325cd1edf957 100644
--- a/drivers/ata/libata-core.c
+++ b/drivers/ata/libata-core.c
@@ -4979,7 +4979,10 @@ int ata_std_qc_defer(struct ata_queued_cmd *qc)
...
@@ -5442,7 +5445,9 @@ void ata_qc_issue(struct ata_queued_cmd *qc)
 		return;
 	}
...
index 52fa8606a25f..c44044baf8e6 100644
...
index 54bfab15c74a..60d842d08f31 100644
...
@@ -1349,7 +1349,7 @@ static int nv_adma_use_reg_mode(struct ata_queued_cmd *qc)
 	return 1;
 }
...
@@ -1361,7 +1361,7 @@ static void nv_adma_qc_prep(struct ata_queued_cmd *qc)
...
@@ -1393,6 +1393,8 @@ static void nv_adma_qc_prep(struct ata_queued_cmd *qc)
...
+	return 0;
 ...
 static unsigned int nv_adma_qc_issue(struct ata_queued_cmd *qc)
@@ -1956,17 +1958,19 @@ static int nv_swncq_port_start(struct ata_port *ap)
 	return 0;
 }
...
index 7ec0c216a6a6..16acf7fb10ad 100644
...
index bfdf41912588..54ef46067514 100644
