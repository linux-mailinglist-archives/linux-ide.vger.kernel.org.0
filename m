Return-Path: <linux-ide+bounces-2208-lists+linux-ide=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ide@lfdr.de
Delivered-To: lists+linux-ide@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id A74AC9686BE
	for <lists+linux-ide@lfdr.de>; Mon,  2 Sep 2024 13:54:10 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id C95401C218AA
	for <lists+linux-ide@lfdr.de>; Mon,  2 Sep 2024 11:54:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BC96B1DAC44;
	Mon,  2 Sep 2024 11:54:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="Jh/VLwWO"
X-Original-To: linux-ide@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9840017F394
	for <linux-ide@vger.kernel.org>; Mon,  2 Sep 2024 11:54:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1725278046; cv=none; b=nHP0ch9JeCFpTDOZFyQJ4CBsr/fMuELsQhlSEGryH2bwIc/gZdS1AihjQsCfznQlkCu750F/Nlj7q9slNILsOCxuWDUnkhwO2fKE2kXYTafRrJbYZWNJDrhaCzsBFh3Xbo1MCJtyDpsYF6ySOvrGtY1NltNZsKt/H4lT8Vxksbo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1725278046; c=relaxed/simple;
	bh=q1XO1oc84pps6eHI21sCyhddLdesocmZu5FYwe0+RME=;
	h=From:To:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=s9jbTkKqytdxbT8EZ+pe01zQwduRaZ8TCJvhPlG2BqEdDV7i8xJ9NMhWcUwWqItup5YSwLNx7dxGcFAZGXDFSvle/lN8L3n5yfrDVZe5xKF8Pv+lxeQGLc08PO6oqU3nnLn9GQmLBLWRuYGBZw6ZmrYUGFlR5S20v5yQKO2xiYc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=Jh/VLwWO; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id BEADBC4CEC8;
	Mon,  2 Sep 2024 11:54:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1725278046;
	bh=q1XO1oc84pps6eHI21sCyhddLdesocmZu5FYwe0+RME=;
	h=From:To:Subject:Date:In-Reply-To:References:From;
	b=
From: Damien Le Moal <dlemoal@kernel.org>
To: linux-ide@vger.kernel.org,
	Niklas Cassel <cassel@kernel.org>
Subject: [PATCH v3 5/7] ata: libata: Rename ata_eh_read_sense_success_ncq_log()
Date: Mon,  2 Sep 2024 20:53:58 +0900
Message-ID: <20240902115400.166881-6-dlemoal@kernel.org>
